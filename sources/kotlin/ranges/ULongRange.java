...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m2200containsVKZWuLQ(((ULong) comparable).m1486unboximpl());
    }

    public ULong getStart() {
        return ULong.m1437boximpl(getFirst());
    }

    public ULong getEndInclusive() {
        return ULong.m1437boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m2200containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m1443constructorimpl(getFirst() ^ ULong.m1443constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m1443constructorimpl(getLast() ^ ULong.m1443constructorimpl(getLast() >>> 32)));
    }

    public String toString() {
        return ULong.m1480toStringimpl(getFirst()) + ".." + ULong.m1480toStringimpl(getLast());
    }

    @Metadata(mo33669bv = {1, 0, 3}, mo33670d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, mo33671d2 = {"Lkotlin/ranges/ULongRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/ULongRange;", "getEMPTY", "()Lkotlin/ranges/ULongRange;", "kotlin-stdlib"}, mo33672k = 1, mo33673mv = {1, 1, 16})
    /* compiled from: ULongRange.kt */

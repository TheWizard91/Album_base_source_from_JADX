...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object item$iv$iv : $this$mapIndexed$iv) {
            ...
            destination$iv$iv.add(TuplesKt.m217to((Class) item$iv$iv, Integer.valueOf(index$iv$iv)));
        ...
        for (String kotlinName : $this$associateTo$iv) {
            ...
            Pair pair = TuplesKt.m217to(append.append(StringsKt.substringAfterLast$default(kotlinName, '.', (String) null, 2, (Object) null)).append("CompanionObject").toString(), kotlinName + ".Companion");

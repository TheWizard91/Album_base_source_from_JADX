...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m2244constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m2289timesmvk6XK0(int $this$times, double duration) {
        return Duration.m2271timesimpl(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m2288timeskIfJnKk(double $this$times, double duration) {
        return Duration.m2270timesimpl(duration, $this$times);
    }
}

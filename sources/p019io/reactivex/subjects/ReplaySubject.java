...
public final class ReplaySubject<T> extends Subject<T> {
    ...
    static final class SizeBoundReplayBuffer<T> extends AtomicReference<Object> implements ReplayBuffer<T> {
        ...
        public T getValue() {
            ...
            Node<Object> next2 = h.value;
            if (next2 == null) {
                return null;
            }
            if (NotificationLite.isComplete(next2) || NotificationLite.isError(next2)) {
                return prev.value;
            }
            return next2;
        }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends AtomicReference<Object> implements ReplayBuffer<T> {
        ...
        public T getValue() {
            ...
            if (h.time < this.scheduler.now(this.unit) - this.maxAge || (v = h.value) == null) {
                return null;
            }
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: io.reactivex.subjects.ReplaySubject$TimedNode<java.lang.Object>} */
        /* access modifiers changed from: package-private */
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public p019io.reactivex.subjects.ReplaySubject.TimedNode<java.lang.Object> getHead() {
            /*
                r7 = this;
                ...
                io.reactivex.subjects.ReplaySubject$TimedNode r3 = (p019io.reactivex.subjects.ReplaySubject.TimedNode) r3
            L_0x0013:
            ...
            L_0x0025:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.subjects.ReplaySubject.SizeAndTimeBoundReplayBuffer.getHead():io.reactivex.subjects.ReplaySubject$TimedNode");
        }

...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    public void connect(p019io.reactivex.functions.Consumer<? super p019io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0000:
            ...
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p019io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x0043:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        public void onSubscribe(Disposable s) {
            DisposableHelper.setOnce(this.f462s, s);
        }

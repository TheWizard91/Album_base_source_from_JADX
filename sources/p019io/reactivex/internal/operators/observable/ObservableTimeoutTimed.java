...
public final class ObservableTimeoutTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class TimeoutObserver<T> extends AtomicLong implements Observer<T>, Disposable, TimeoutSupport {
        ...
        TimeoutObserver(Observer<? super T> actual2, long timeout2, TimeUnit unit2, Scheduler.Worker worker2) {
            this.actual = actual2;
            this.timeout = timeout2;
            this.unit = unit2;
            this.worker = worker2;
    ...
    static final class TimeoutFallbackObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable, TimeoutSupport {
        ...
        TimeoutFallbackObserver(Observer<? super T> actual2, long timeout2, TimeUnit unit2, Scheduler.Worker worker2, ObservableSource<? extends T> fallback2) {
            this.actual = actual2;
            this.timeout = timeout2;
            this.unit = unit2;
            this.worker = worker2;

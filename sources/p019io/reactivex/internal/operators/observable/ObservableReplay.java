...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    static abstract class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v3, resolved type: io.reactivex.internal.operators.observable.ObservableReplay$Node} */
        /* access modifiers changed from: package-private */
        ...
        public final void removeSome(int r3) {
            /*
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$Node r0 = (p019io.reactivex.internal.operators.observable.ObservableReplay.Node) r0
            L_0x0006:
            ...
            L_0x0018:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.observable.ObservableReplay.BoundedReplayBuffer.removeSome(int):void");
        }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public void truncate() {
            /*
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$Node r2 = (p019io.reactivex.internal.operators.observable.ObservableReplay.Node) r2
                java.lang.Object r3 = r2.get()
                io.reactivex.internal.operators.observable.ObservableReplay$Node r3 = (p019io.reactivex.internal.operators.observable.ObservableReplay.Node) r3
                r4 = 0
            L_0x0018:
            ...
            L_0x0053:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.truncate():void");
        }
        ...
        public void truncateFinal() {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
        ...
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public p019io.reactivex.internal.operators.observable.ObservableReplay.Node getHead() {
            /*
                r7 = this;
            ...
            L_0x0044:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.getHead():io.reactivex.internal.operators.observable.ObservableReplay$Node");
        }
    }
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        /* renamed from: co */
        private final ConnectableObservable<T> f470co;
        private final Observable<T> observable;

        Replay(ConnectableObservable<T> co, Observable<T> observable2) {
            this.f470co = co;
            this.observable = observable2;
        }

        public void connect(Consumer<? super Disposable> connection) {
            this.f470co.connect(connection);
        }

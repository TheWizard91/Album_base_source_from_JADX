...
public final class ObservableWindowBoundarySupplier<T, B> extends AbstractObservableWithUpstream<T, Observable<T>> {
    ...
    static final class WindowBoundaryMainObserver<T, B> extends AtomicInteger implements Observer<T>, Disposable, Runnable {
        ...
        public void disposeBoundary() {
            ...
            Disposable d = atomicReference.getAndSet(windowBoundaryInnerObserver);
        ...
        public void innerNext(WindowBoundaryInnerObserver<T, B> sender) {
            this.boundaryObserver.compareAndSet(sender, (Object) null);
            this.queue.offer(NEXT_WINDOW);
            drain();
        }
                        ...
                        if (d && empty) {
                            ...
                            if (!this.stopWindows.get()) {
                                ...
                                try {
                                    ...
                                    if (this.boundaryObserver.compareAndSet((Object) null, bo)) {
                                        observableSource.subscribe(bo);

...
import p019io.reactivex.internal.util.BlockingIgnoringReceiver;
...
public final class FlowableBlockingSubscribe {
    ...
    public static <T> void subscribe(org.reactivestreams.Publisher<? extends T> r4, org.reactivestreams.Subscriber<? super T> r5) {
        ...
        L_0x0014:
            ...
            goto L_0x003c
        L_0x0021:
            p019io.reactivex.internal.util.BlockingHelper.verifyNonBlocking()     // Catch:{ InterruptedException -> 0x003d }
        ...
        L_0x0029:
            ...
            goto L_0x003c
        L_0x0030:
            java.lang.Object r3 = p019io.reactivex.internal.subscribers.BlockingSubscriber.TERMINATED     // Catch:{ InterruptedException -> 0x003d }
            if (r4 == r3) goto L_0x003c
            boolean r3 = p019io.reactivex.internal.util.NotificationLite.acceptFull((java.lang.Object) r2, r5)     // Catch:{ InterruptedException -> 0x003d }
        ...
        L_0x0044:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.flowable.FlowableBlockingSubscribe.subscribe(org.reactivestreams.Publisher, org.reactivestreams.Subscriber):void");
    }

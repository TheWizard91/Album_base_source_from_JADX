...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.f530s, s)) {
                this.f530s = s;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r1 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, (java.lang.String) r5)     // Catch:{ all -> 0x001c }
            ...
            L_0x001c:
                ...
                java.lang.Object r6 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0057 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p019io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0057 }
                int[] r7 = p019io.reactivex.internal.operators.parallel.ParallelMapTry.C17381.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r8 = r6.ordinal()
                r7 = r7[r8]
            ...
            L_0x0057:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTrySubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.f529s, s)) {
                this.f529s = s;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r0 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, (java.lang.String) r4)     // Catch:{ all -> 0x001c }
            ...
            L_0x001c:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0058 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p019io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0058 }
                int[] r7 = p019io.reactivex.internal.operators.parallel.ParallelMapTry.C17381.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r8 = r6.ordinal()
                r7 = r7[r8]
            ...
            L_0x0058:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTryConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }

...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.f523s, s)) {
                this.f523s = s;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0018:
                ...
                java.lang.Object r6 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0053 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p019io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0053 }
                int[] r7 = p019io.reactivex.internal.operators.parallel.ParallelFilterTry.C17371.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r8 = r6.ordinal()
                r7 = r7[r8]
            ...
            L_0x0069:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x001b:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p019io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0056 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p019io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0056 }
                int[] r7 = p019io.reactivex.internal.operators.parallel.ParallelFilterTry.C17371.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r8 = r6.ordinal()
                r7 = r7[r8]
            ...
            L_0x006c:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }

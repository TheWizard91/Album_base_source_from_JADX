...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        public void onSubscribe(Subscription s) {
            if (SubscriptionHelper.validate(this.f524s, s)) {
                this.f524s = s;
        ...
        final class RailSubscription implements Subscription {
            ...
            public void request(long n) {
                ...
                if (SubscriptionHelper.validate(n)) {
                    ...
                    } while (!ra.compareAndSet(this.f525j, r, BackpressureHelper.addCap(r, n)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f526m) {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f525j + this.f526m, 0, 1)) {
        ...
        public void drainAsync() {
            ...
            L_0x009c:
                ...
                org.reactivestreams.Subscription r4 = r1.f524s
                r4.cancel()
                int r4 = r3.length
            L_0x00ac:
            ...
            L_0x00e4:
                ...
                goto L_0x0019
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.reactivex.internal.operators.parallel.ParallelFromPublisher.ParallelDispatcher.drainAsync():void");
        }

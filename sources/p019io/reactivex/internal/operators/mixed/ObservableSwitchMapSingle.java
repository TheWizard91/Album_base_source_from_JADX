...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    public void subscribeActual(Observer<? super R> s) {
        if (!ScalarXMapZHelper.tryAsSingle(this.source, this.mapper, s)) {
            this.source.subscribe(new SwitchMapSingleMainObserver(s, this.mapper, this.delayErrors));
        }
    }
    ...
    static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void disposeInner() {
            ...
            SwitchMapSingleObserver<R> current = atomicReference.getAndSet(switchMapSingleObserver);
        ...
        public void innerError(SwitchMapSingleObserver<R> sender, Throwable ex) {
            if (!this.inner.compareAndSet(sender, (Object) null) || !this.errors.addThrowable(ex)) {
                ...
                while (!this.cancelled) {
                    if (errors2.get() == null || this.delayErrors) {
                        ...
                        if (d && empty) {
                            ...
                            inner2.compareAndSet(current, (Object) null);

...
import p019io.reactivex.internal.util.VolatileSizeArrayList;
...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    public final U assertValues(T... values2) {
        ...
        throw fail("Value count differs; Expected: " + values2.length + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Arrays.toString(values2) + ", Actual: " + s + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.values);
    }

package p019io.reactivex.schedulers;

import java.util.concurrent.Callable;
import java.util.concurrent.Executor;
import p019io.reactivex.Scheduler;
import p019io.reactivex.internal.schedulers.ComputationScheduler;
import p019io.reactivex.internal.schedulers.ExecutorScheduler;
import p019io.reactivex.internal.schedulers.IoScheduler;
import p019io.reactivex.internal.schedulers.NewThreadScheduler;
import p019io.reactivex.internal.schedulers.SchedulerPoolFactory;
import p019io.reactivex.internal.schedulers.SingleScheduler;
...
public final class Schedulers {
    ...
    /* renamed from: IO */
    static final Scheduler f604IO = RxJavaPlugins.initIoScheduler(new IOTask());
    ...
    /* renamed from: io */
    public static Scheduler m207io() {
        return RxJavaPlugins.onIoScheduler(f604IO);
    }

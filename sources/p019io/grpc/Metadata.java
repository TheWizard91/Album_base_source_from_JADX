...
import com.google.common.p028io.ByteStreams;
...
public final class Metadata {
    ...
    public static abstract class Key<T> {
        ...
        /* renamed from: of */
        public static <T> Key<T> m189of(String name2, BinaryMarshaller<T> marshaller2) {
            return new BinaryKey(name2, marshaller2);
        }

        /* renamed from: of */
        public static <T> Key<T> m190of(String name2, BinaryStreamMarshaller<T> marshaller2) {
            return new LazyStreamBinaryKey(name2, marshaller2);
        }

        /* renamed from: of */
        public static <T> Key<T> m188of(String name2, AsciiMarshaller<T> marshaller2) {
            return m191of(name2, false, marshaller2);
        }

        /* renamed from: of */
        static <T> Key<T> m191of(String name2, boolean pseudo, AsciiMarshaller<T> marshaller2) {
            return new AsciiKey(name2, pseudo, marshaller2);
        }

        /* renamed from: of */
        static <T> Key<T> m192of(String name2, boolean pseudo, TrustedAsciiMarshaller<T> marshaller2) {

...
import p019io.grpc.HttpConnectProxiedSocketAddress;
...
import p019io.grpc.StatusException;
...
import p019io.grpc.internal.Http2Ping;
import p019io.grpc.internal.InUseStateAggregator;
import p019io.grpc.internal.KeepAliveManager;
import p019io.grpc.internal.ManagedClientTransport;
import p019io.grpc.internal.SerializingExecutor;
import p019io.grpc.internal.SharedResourceHolder;
import p019io.grpc.internal.StatsTraceContext;
import p019io.grpc.internal.TransportTracer;
import p019io.grpc.okhttp.ExceptionHandlingFrameWriter;
import p019io.grpc.okhttp.OkHttpFrameLogger;
import p019io.grpc.okhttp.internal.ConnectionSpec;
import p019io.grpc.okhttp.internal.framed.ErrorCode;
import p019io.grpc.okhttp.internal.framed.FrameReader;
import p019io.grpc.okhttp.internal.framed.FrameWriter;
import p019io.grpc.okhttp.internal.framed.Header;
import p019io.grpc.okhttp.internal.framed.HeadersMode;
import p019io.grpc.okhttp.internal.framed.Http2;
import p019io.grpc.okhttp.internal.framed.Settings;
import p019io.grpc.okhttp.internal.framed.Variant;
...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    public void ping(p019io.grpc.internal.ClientTransport.PingCallback r10, java.util.concurrent.Executor r11) {
        /*
            r9 = this;
            r0 = 0
        ...
        L_0x000d:
            ...
            p019io.grpc.internal.Http2Ping.notifyFailed(r10, r11, r3)     // Catch:{ all -> 0x0057 }
        ...
        L_0x0057:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.okhttp.OkHttpClientTransport.ping(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    private void startStream(OkHttpClientStream stream) {
        Preconditions.checkState(stream.mo30826id() == -1, "StreamId already assigned");
    ...
    private Request createHttpProxyRequest(InetSocketAddress address2, String proxyUsername, String proxyPassword) {
        HttpUrl tunnelUrl = new HttpUrl.Builder().scheme(UriUtil.HTTPS_SCHEME).host(address2.getHostName()).port(address2.getPort()).build();
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x006c, code lost:
            p019io.grpc.okhttp.OkHttpClientTransport.access$2200(r10.this$0, p019io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR, "Received window_update for unknown stream: " + r11);
         */
        ...
        public void windowUpdate(int r11, long r12) {
            /*
                ...
                io.grpc.okhttp.OkHttpFrameLogger$Direction r1 = p019io.grpc.okhttp.OkHttpFrameLogger.Direction.INBOUND
                ...
                io.grpc.okhttp.OkHttpClientTransport r1 = p019io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r2 = p019io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r1.onError(r2, r0)
                goto L_0x002b
            L_0x0019:
                io.grpc.okhttp.OkHttpClientTransport r3 = p019io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.Status r1 = p019io.grpc.Status.INTERNAL
                io.grpc.Status r5 = r1.withDescription(r0)
                io.grpc.internal.ClientStreamListener$RpcProgress r6 = p019io.grpc.internal.ClientStreamListener.RpcProgress.PROCESSED
                r7 = 0
                io.grpc.okhttp.internal.framed.ErrorCode r8 = p019io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r9 = 0
                r4 = r11
            ...
            L_0x002c:
                ...
                io.grpc.okhttp.OkHttpClientTransport r2 = p019io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0087 }
            ...
            L_0x0043:
                ...
                io.grpc.okhttp.OkHttpClientStream r2 = (p019io.grpc.okhttp.OkHttpClientStream) r2     // Catch:{ all -> 0x0087 }
                if (r2 == 0) goto L_0x0060
                io.grpc.okhttp.OkHttpClientTransport r3 = p019io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0087 }
            ...
            L_0x0087:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.okhttp.OkHttpClientTransport.ClientFrameHandler.windowUpdate(int, long):void");
        }

...
public final class Status {
    ...
    static final Metadata.Key<Status> CODE_KEY = Metadata.Key.m192of("grpc-status", false, new StatusCodeMarshaller());
    ...
    /* renamed from: OK */
    public static final Status f193OK = Code.OK.toStatus();
    ...
    static {
        ...
        MESSAGE_KEY = Metadata.Key.m192of("grpc-message", false, statusMessageMarshaller);
    }
        ...
        private static byte[] toAsciiStringSlow(byte[] valueBytes, int ri) {
            ...
            while (ri < valueBytes.length) {
                ...
                if (isEscapingChar(b)) {
                    ...
                    escapedBytes[wi + 2] = bArr[b & Ascii.f1613SI];
                    wi += 3;
                } else {
                    escapedBytes[wi] = b;
                    wi++;

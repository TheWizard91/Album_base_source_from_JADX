...
public class Http2Ping {
    ...
    public void addCallback(p019io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x000c:
            ...
            java.lang.Runnable r0 = asRunnable((p019io.grpc.internal.ClientTransport.PingCallback) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x0021 }
            goto L_0x001b
        L_0x0015:
            long r0 = r2.roundTripTimeNanos     // Catch:{ all -> 0x0021 }
            java.lang.Runnable r0 = asRunnable((p019io.grpc.internal.ClientTransport.PingCallback) r3, (long) r0)     // Catch:{ all -> 0x0021 }
        L_0x001b:
            monitor-exit(r2)     // Catch:{ all -> 0x0021 }
            doExecute(r4, r0)
            return
        L_0x0021:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.Http2Ping.addCallback(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    public boolean complete() {
        ...
        L_0x0023:
            ...
            io.grpc.internal.ClientTransport$PingCallback r7 = (p019io.grpc.internal.ClientTransport.PingCallback) r7
            java.lang.Runnable r7 = asRunnable((p019io.grpc.internal.ClientTransport.PingCallback) r7, (long) r1)
            doExecute(r6, r7)
            goto L_0x0023
        L_0x0043:
            return r0
        L_0x0044:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.Http2Ping.complete():boolean");
    }
    ...
    public void failed(java.lang.Throwable r6) {
        ...
        L_0x001a:
            ...
            io.grpc.internal.ClientTransport$PingCallback r3 = (p019io.grpc.internal.ClientTransport.PingCallback) r3
        ...
        L_0x0037:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.Http2Ping.failed(java.lang.Throwable):void");
    }

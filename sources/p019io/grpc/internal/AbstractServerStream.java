...
import p019io.grpc.InternalStatus;
import p019io.grpc.Metadata;
import p019io.grpc.Status;
import p019io.grpc.internal.AbstractStream;
import p019io.grpc.internal.MessageFramer;
...
public abstract class AbstractServerStream extends AbstractStream implements ServerStream, MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends AbstractStream.TransportState {
        ...
        public void complete() {
            if (this.deframerClosed) {
                this.deframerClosedTask = null;
                closeListener(Status.f193OK);
                return;
            }
            this.deframerClosedTask = new Runnable() {
                public void run() {
                    TransportState.this.closeListener(Status.f193OK);
                }
            };
            this.immediateCloseRequested = true;
            closeDeframer(true);

...
class GzipInflatingBuffer implements Closeable {
    ...
    private final GzipMetadataReader gzipMetadataReader = new GzipMetadataReader(this, (C16391) null);
    /* access modifiers changed from: private */
    ...
    private class GzipMetadataReader {
        ...
        /* synthetic */ GzipMetadataReader(GzipInflatingBuffer x0, C16391 x1) {
            this();
        }
    ...
    public int inflateBytes(byte[] b, int offset, int length) throws DataFormatException, ZipException {
        ...
        while (madeProgress) {
            ...
            int missingBytes = i;
            if (i > 0) {
                switch (C16391.$SwitchMap$io$grpc$internal$GzipInflatingBuffer$State[this.state.ordinal()]) {
                    case 1:

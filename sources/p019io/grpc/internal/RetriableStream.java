...
import p019io.grpc.ClientStreamTracer;
...
import p019io.grpc.internal.HedgingPolicy;
import p019io.grpc.internal.RetryPolicy;
...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    static final Metadata.Key<String> GRPC_PREVIOUS_RPC_ATTEMPTS = Metadata.Key.m188of("grpc-previous-rpc-attempts", Metadata.ASCII_STRING_MARSHALLER);
    static final Metadata.Key<String> GRPC_RETRY_PUSHBACK_MS = Metadata.Key.m188of("grpc-retry-pushback-ms", Metadata.ASCII_STRING_MARSHALLER);
    /* access modifiers changed from: private */
    ...
    public void drain(p019io.grpc.internal.RetriableStream.Substream r9) {
        /*
            r8 = this;
            r0 = 0
        ...
        L_0x005d:
            ...
            io.grpc.internal.RetriableStream$BufferEntry r5 = (p019io.grpc.internal.RetriableStream.BufferEntry) r5
        ...
        L_0x008b:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.RetriableStream.drain(io.grpc.internal.RetriableStream$Substream):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x002b, code lost:
        r3.setFuture(r7.scheduledExecutorService.schedule(new p019io.grpc.internal.RetriableStream.HedgingRunnable(r7, r3), (long) r8.intValue(), java.util.concurrent.TimeUnit.MILLISECONDS));
     */
    ...
    public void pushbackHedging(@javax.annotation.Nullable java.lang.Integer r8) {
        ...
        L_0x0041:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.RetriableStream.pushbackHedging(java.lang.Integer):void");
    }
    ...
    private final class Sublistener implements ClientStreamListener {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void closed(p019io.grpc.Status r9, p019io.grpc.internal.ClientStreamListener.RpcProgress r10, p019io.grpc.Metadata r11) {
            /*
                r8 = this;
                io.grpc.internal.RetriableStream r0 = p019io.grpc.internal.RetriableStream.this
                java.lang.Object r0 = r0.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01c5 }
                io.grpc.internal.RetriableStream$State r2 = r1.state     // Catch:{ all -> 0x01c5 }
                io.grpc.internal.RetriableStream$Substream r3 = r8.substream     // Catch:{ all -> 0x01c5 }
                io.grpc.internal.RetriableStream$State r2 = r2.substreamClosed(r3)     // Catch:{ all -> 0x01c5 }
                p019io.grpc.internal.RetriableStream.State unused = r1.state = r2     // Catch:{ all -> 0x01c5 }
                io.grpc.internal.RetriableStream r1 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01c5 }
                io.grpc.internal.InsightBuilder r1 = r1.closedSubstreamsInsight     // Catch:{ all -> 0x01c5 }
                io.grpc.Status$Code r2 = r9.getCode()     // Catch:{ all -> 0x01c5 }
                r1.append(r2)     // Catch:{ all -> 0x01c5 }
            ...
            L_0x0047:
                ...
                r0 = 0
                io.grpc.internal.ClientStreamListener$RpcProgress r1 = p019io.grpc.internal.ClientStreamListener.RpcProgress.REFUSED
                r2 = 1
                if (r10 != r1) goto L_0x00e8
                io.grpc.internal.RetriableStream r1 = p019io.grpc.internal.RetriableStream.this
                ...
                io.grpc.internal.RetriableStream r3 = p019io.grpc.internal.RetriableStream.this
                boolean r3 = r3.isHedging
                if (r3 == 0) goto L_0x00b5
                r3 = 0
                io.grpc.internal.RetriableStream r4 = p019io.grpc.internal.RetriableStream.this
                java.lang.Object r4 = r4.lock
                monitor-enter(r4)
                io.grpc.internal.RetriableStream r5 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream$State r6 = r5.state     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream$Substream r7 = r8.substream     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream$State r6 = r6.replaceActiveHedge(r7, r1)     // Catch:{ all -> 0x00b2 }
                p019io.grpc.internal.RetriableStream.State unused = r5.state = r6     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream r5 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream$State r6 = r5.state     // Catch:{ all -> 0x00b2 }
                boolean r5 = r5.hasPotentialHedging(r6)     // Catch:{ all -> 0x00b2 }
                if (r5 != 0) goto L_0x00a9
                io.grpc.internal.RetriableStream r5 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x00b2 }
                io.grpc.internal.RetriableStream$State r5 = r5.state     // Catch:{ all -> 0x00b2 }
                java.util.Collection<io.grpc.internal.RetriableStream$Substream> r5 = r5.activeHedges     // Catch:{ all -> 0x00b2 }
                int r5 = r5.size()     // Catch:{ all -> 0x00b2 }
            ...
            L_0x00a9:
                ...
                io.grpc.internal.RetriableStream r2 = p019io.grpc.internal.RetriableStream.this
                r2.commitAndRun(r1)
            L_0x00b1:
                goto L_0x00d9
            L_0x00b2:
            ...
            L_0x00b5:
                ...
                p019io.grpc.internal.RetryPolicy unused = r3.retryPolicy = r4
            L_0x00ca:
                io.grpc.internal.RetriableStream r3 = p019io.grpc.internal.RetriableStream.this
                io.grpc.internal.RetryPolicy r3 = r3.retryPolicy
            ...
            L_0x00d9:
                ...
                return
            L_0x00e8:
                io.grpc.internal.ClientStreamListener$RpcProgress r1 = p019io.grpc.internal.ClientStreamListener.RpcProgress.DROPPED
            ...
            L_0x00fa:
                ...
                p019io.grpc.internal.RetryPolicy unused = r1.retryPolicy = r2
                io.grpc.internal.RetriableStream r1 = p019io.grpc.internal.RetriableStream.this
            ...
            L_0x0123:
                ...
                monitor-enter(r2)
                io.grpc.internal.RetriableStream r3 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x015b }
                io.grpc.internal.RetriableStream$FutureCanceller r4 = new io.grpc.internal.RetriableStream$FutureCanceller     // Catch:{ all -> 0x015b }
                io.grpc.internal.RetriableStream r5 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x015b }
                java.lang.Object r5 = r5.lock     // Catch:{ all -> 0x015b }
                r4.<init>(r5)     // Catch:{ all -> 0x015b }
                r5 = r4
                p019io.grpc.internal.RetriableStream.FutureCanceller unused = r3.scheduledRetry = r4     // Catch:{ all -> 0x015b }
            ...
            L_0x0167:
                ...
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01a5 }
                io.grpc.internal.RetriableStream$State r3 = r2.state     // Catch:{ all -> 0x01a5 }
                io.grpc.internal.RetriableStream$Substream r4 = r8.substream     // Catch:{ all -> 0x01a5 }
                io.grpc.internal.RetriableStream$State r3 = r3.removeActiveHedge(r4)     // Catch:{ all -> 0x01a5 }
                p019io.grpc.internal.RetriableStream.State unused = r2.state = r3     // Catch:{ all -> 0x01a5 }
                if (r0 != 0) goto L_0x01a3
                io.grpc.internal.RetriableStream r2 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01a5 }
                io.grpc.internal.RetriableStream$State r3 = r2.state     // Catch:{ all -> 0x01a5 }
                boolean r2 = r2.hasPotentialHedging(r3)     // Catch:{ all -> 0x01a5 }
                if (r2 != 0) goto L_0x01a1
                io.grpc.internal.RetriableStream r2 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01a5 }
                io.grpc.internal.RetriableStream$State r2 = r2.state     // Catch:{ all -> 0x01a5 }
                java.util.Collection<io.grpc.internal.RetriableStream$Substream> r2 = r2.activeHedges     // Catch:{ all -> 0x01a5 }
                boolean r2 = r2.isEmpty()     // Catch:{ all -> 0x01a5 }
            ...
            L_0x01c5:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.RetriableStream.Sublistener.closed(io.grpc.Status, io.grpc.internal.ClientStreamListener$RpcProgress, io.grpc.Metadata):void");
        }
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r9) {
            ...
            L_0x000b:
                ...
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0087 }
            ...
            L_0x0024:
                ...
                io.grpc.internal.RetriableStream r4 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0087 }
            ...
            L_0x0047:
                ...
                io.grpc.internal.RetriableStream r6 = p019io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0087 }
            ...
            L_0x0087:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.RetriableStream.BufferSizeTracer.outboundWireSize(long):void");
        }
    }
    ...
    static final class Throttle {
        ...
        void onSuccess() {
            ...
            L_0x001c:
                goto L_0x0000
            */
            throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.internal.RetriableStream.Throttle.onSuccess():void");
        }

...
public final class ServerInterceptors {
    ...
    private static <ReqT, RespT> void wrapAndAddMethod(p019io.grpc.ServerServiceDefinition.Builder r3, p019io.grpc.ServerMethodDefinition<ReqT, RespT> r4, java.util.List<? extends p019io.grpc.ServerInterceptor> r5) {
        /*
        ...
        L_0x0008:
            ...
            io.grpc.ServerInterceptor r2 = (p019io.grpc.ServerInterceptor) r2
            io.grpc.ServerInterceptors$InterceptCallHandler r0 = p019io.grpc.ServerInterceptors.InterceptCallHandler.create(r2, r0)
            goto L_0x0008
        L_0x0019:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.ServerInterceptors.wrapAndAddMethod(io.grpc.ServerServiceDefinition$Builder, io.grpc.ServerMethodDefinition, java.util.List):void");
    }

            ...
            if (!newBalancerFactory.equals(this.currentBalancerFactory)) {
                AnonymousClass1PendingHelper pendingHelper = new ForwardingLoadBalancerHelper() {
                    ...
                    public void updateBalancingState(ConnectivityState newState, LoadBalancer.SubchannelPicker newPicker) {
                        if (this.f199lb == GracefulSwitchLoadBalancer.this.pendingLb) {
                        ...
                        } else if (this.f199lb == GracefulSwitchLoadBalancer.this.currentLb) {
                ...
                pendingHelper.f199lb = newBalancerFactory.newLoadBalancer(pendingHelper);
                this.pendingLb = pendingHelper.f199lb;

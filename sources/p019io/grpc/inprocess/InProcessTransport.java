...
import p019io.grpc.Grpc;
import p019io.grpc.InternalChannelz;
import p019io.grpc.InternalLogId;
import p019io.grpc.InternalMetadata;
import p019io.grpc.Metadata;
import p019io.grpc.MethodDescriptor;
import p019io.grpc.SecurityLevel;
import p019io.grpc.ServerStreamTracer;
import p019io.grpc.Status;
import p019io.grpc.internal.ClientStream;
import p019io.grpc.internal.ClientStreamListener;
import p019io.grpc.internal.ClientTransport;
import p019io.grpc.internal.ConnectionClientTransport;
import p019io.grpc.internal.GrpcAttributes;
import p019io.grpc.internal.GrpcUtil;
import p019io.grpc.internal.InUseStateAggregator;
import p019io.grpc.internal.InsightBuilder;
import p019io.grpc.internal.ManagedClientTransport;
import p019io.grpc.internal.NoopClientStream;
import p019io.grpc.internal.ObjectPool;
import p019io.grpc.internal.ServerStream;
import p019io.grpc.internal.ServerStreamListener;
import p019io.grpc.internal.ServerTransport;
import p019io.grpc.internal.ServerTransportListener;
...
final class InProcessTransport implements ServerTransport, ConnectionClientTransport {
    ...
    public synchronized Runnable start(ManagedClientTransport.Listener listener) {
        ...
        if (this.serverTransportListener == null) {
            final Status localShutdownStatus = Status.UNAVAILABLE.withDescription("Could not find server: " + this.name);
    ...
    public synchronized void shutdown(p019io.grpc.Status r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        ...
        L_0x0019:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.shutdown(io.grpc.Status):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0021, code lost:
        p019io.grpc.inprocess.InProcessTransport.InProcessStream.access$700(r1.next()).cancel(r5);
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void shutdownNow(p019io.grpc.Status r5) {
        /*
            r4 = this;
        ...
        L_0x001b:
            ...
            io.grpc.inprocess.InProcessTransport$InProcessStream r2 = (p019io.grpc.inprocess.InProcessTransport.InProcessStream) r2
        ...
        L_0x0030:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.shutdownNow(io.grpc.Status):void");
    }
    ...
    public synchronized void notifyTerminated() {
        ...
        L_0x0026:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.notifyTerminated():void");
    }
        ...
        private class InProcessServerStream implements ServerStream {
            ...
            public synchronized boolean clientRequested(int r7) {
                /*
                    r6 = this;
                    monitor-enter(r6)
                    boolean r0 = r6.closed     // Catch:{ all -> 0x0077 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0008
                    monitor-exit(r6)
                    return r1
                L_0x0008:
                    int r0 = r6.clientRequested     // Catch:{ all -> 0x0077 }
                    r2 = 1
                    if (r0 <= 0) goto L_0x000f
                    r3 = r2
                    goto L_0x0010
                ...
                L_0x0010:
                    int r0 = r0 + r7
                    r6.clientRequested = r0     // Catch:{ all -> 0x0077 }
                L_0x0013:
                    int r0 = r6.clientRequested     // Catch:{ all -> 0x0077 }
                    if (r0 <= 0) goto L_0x0032
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r0 = r6.clientReceiveQueue     // Catch:{ all -> 0x0077 }
                    boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0077 }
                    if (r0 != 0) goto L_0x0032
                    int r0 = r6.clientRequested     // Catch:{ all -> 0x0077 }
                    int r0 = r0 - r2
                    r6.clientRequested = r0     // Catch:{ all -> 0x0077 }
                    io.grpc.internal.ClientStreamListener r0 = r6.clientStreamListener     // Catch:{ all -> 0x0077 }
                    java.util.ArrayDeque<io.grpc.internal.StreamListener$MessageProducer> r4 = r6.clientReceiveQueue     // Catch:{ all -> 0x0077 }
                    java.lang.Object r4 = r4.poll()     // Catch:{ all -> 0x0077 }
                    io.grpc.internal.StreamListener$MessageProducer r4 = (p019io.grpc.internal.StreamListener.MessageProducer) r4     // Catch:{ all -> 0x0077 }
                    r0.messagesAvailable(r4)     // Catch:{ all -> 0x0077 }
                    goto L_0x0013
                L_0x0032:
                    boolean r0 = r6.closed     // Catch:{ all -> 0x0077 }
                ...
                L_0x0038:
                    ...
                    io.grpc.Status r0 = r6.clientNotifyStatus     // Catch:{ all -> 0x0077 }
                    if (r0 == 0) goto L_0x0069
                    r6.closed = r2     // Catch:{ all -> 0x0077 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p019io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0077 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0077 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0077 }
                    io.grpc.Metadata r4 = r6.clientNotifyTrailers     // Catch:{ all -> 0x0077 }
                    r0.clientInboundTrailers(r4)     // Catch:{ all -> 0x0077 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p019io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0077 }
                    io.grpc.inprocess.InProcessTransport$InProcessStream$InProcessClientStream r0 = r0.clientStream     // Catch:{ all -> 0x0077 }
                    io.grpc.internal.StatsTraceContext r0 = r0.statsTraceCtx     // Catch:{ all -> 0x0077 }
                    io.grpc.Status r4 = r6.clientNotifyStatus     // Catch:{ all -> 0x0077 }
                    r0.streamClosed(r4)     // Catch:{ all -> 0x0077 }
                    io.grpc.internal.ClientStreamListener r0 = r6.clientStreamListener     // Catch:{ all -> 0x0077 }
                    io.grpc.Status r4 = r6.clientNotifyStatus     // Catch:{ all -> 0x0077 }
                    io.grpc.Metadata r5 = r6.clientNotifyTrailers     // Catch:{ all -> 0x0077 }
                    r0.closed(r4, r5)     // Catch:{ all -> 0x0077 }
                L_0x0069:
                    int r0 = r6.clientRequested     // Catch:{ all -> 0x0077 }
                ...
                L_0x0077:
                    ...
                    throw r7
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.clientRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x0007:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r0 = p019io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x0058 }
                ...
                L_0x0058:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.isReady():boolean");
            }
            ...
            public void close(Status status, Metadata trailers) {
                InProcessStream.this.clientStream.serverClosed(Status.f193OK, status);
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:12:0x0037, code lost:
                p019io.grpc.inprocess.InProcessTransport.InProcessStream.access$1900(r2.this$1);
             */
            /* JADX WARNING: Code restructure failed: missing block: B:13:0x003c, code lost:
                return;
             */
            /* Code decompiled incorrectly, please refer to instructions dump. */
            private void notifyClientClose(p019io.grpc.Status r3, p019io.grpc.Metadata r4) {
                /*
                    r2 = this;
                    io.grpc.Status r0 = p019io.grpc.inprocess.InProcessTransport.stripCause(r3)
                    monitor-enter(r2)
                ...
                L_0x000b:
                    ...
                    io.grpc.inprocess.InProcessTransport$InProcessStream r1 = p019io.grpc.inprocess.InProcessTransport.InProcessStream.this     // Catch:{ all -> 0x003d }
                ...
                L_0x0036:
                    monitor-exit(r2)     // Catch:{ all -> 0x003d }
                    io.grpc.inprocess.InProcessTransport$InProcessStream r1 = p019io.grpc.inprocess.InProcessTransport.InProcessStream.this
                    r1.streamClosed()
                    return
                L_0x003d:
                    r1 = move-exception
                    ...
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessServerStream.notifyClientClose(io.grpc.Status, io.grpc.Metadata):void");
            }
        ...
        private class InProcessClientStream implements ClientStream {
            ...
            public synchronized boolean serverRequested(int r6) {
                ...
                L_0x0013:
                    ...
                    io.grpc.internal.StreamListener$MessageProducer r4 = (p019io.grpc.internal.StreamListener.MessageProducer) r4     // Catch:{ all -> 0x0053 }
                ...
                L_0x0053:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.serverRequested(int):boolean");
            }
            ...
            public synchronized void writeMessage(java.io.InputStream r9) {
                ...
                L_0x0058:
                    ...
                    throw r9
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.writeMessage(java.io.InputStream):void");
            }
            ...
            public synchronized boolean isReady() {
                ...
                L_0x000f:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.isReady():boolean");
            }
            ...
            public synchronized void halfClose() {
                ...
                L_0x001a:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: p019io.grpc.inprocess.InProcessTransport.InProcessStream.InProcessClientStream.halfClose():void");
            }

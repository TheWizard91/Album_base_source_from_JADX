...
final class SafeFlow<T> implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        return this.block.invoke(new SafeCollector(collector, $completion.getContext()), $completion);
    }
}

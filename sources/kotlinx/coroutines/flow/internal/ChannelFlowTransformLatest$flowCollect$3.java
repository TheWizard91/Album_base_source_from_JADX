...
@Metadata(mo33669bv = {1, 0, 3}, mo33670d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H@¢\u0006\u0004\b\u0005\u0010\u0006"}, mo33671d2 = {"<anonymous>", "", "T", "R", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;"}, mo33672k = 3, mo33673mv = {1, 1, 15})
@DebugMetadata(mo34304c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", mo34305f = "Merge.kt", mo34306i = {0, 0, 0}, mo34307l = {79}, mo34308m = "invokeSuspend", mo34309n = {"$this$flowScope", "previousFlow", "$this$collect$iv"}, mo34310s = {"L$0", "L$1", "L$2"})
...
final class ChannelFlowTransformLatest$flowCollect$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            CoroutineScope $this$flowScope = this.f696p$;
            Ref.ObjectRef objectRef = new Ref.ObjectRef();
            objectRef.element = (Job) null;
            Ref.ObjectRef previousFlow = objectRef;
            Flow $this$collect$iv = this.this$0.flow;
            this.L$0 = $this$flowScope;
            this.L$1 = previousFlow;
            this.L$2 = $this$collect$iv;
            this.label = 1;
            if ($this$collect$iv.collect(new C1916xfa64eeb5(this, $this$flowScope, previousFlow), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
            CoroutineScope coroutineScope = $this$flowScope;
        } else if (i == 1) {
            Flow $this$collect$iv2 = (Flow) this.L$2;
            Ref.ObjectRef previousFlow2 = (Ref.ObjectRef) this.L$1;

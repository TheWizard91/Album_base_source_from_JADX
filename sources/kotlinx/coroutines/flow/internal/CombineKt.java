...
public final class CombineKt {
    ...
    public static final <T1, T2, R> Object combineTransformInternal(FlowCollector<? super R> $this$combineTransformInternal, Flow<? extends T1> first, Flow<? extends T2> second, Function4<? super FlowCollector<? super R>, ? super T1, ? super T2, ? super Continuation<? super Unit>, ? extends Object> transform, Continuation<? super Unit> $completion) {
        return CoroutineScopeKt.coroutineScope(new CombineKt$combineTransformInternal$2($this$combineTransformInternal, first, second, transform, (Continuation) null), $completion);
    }
    ...
    public static final <R, T> Object combineInternal(FlowCollector<? super R> $this$combineInternal, Flow<? extends T>[] flows, Function0<T[]> arrayFactory, Function3<? super FlowCollector<? super R>, ? super T[], ? super Continuation<? super Unit>, ? extends Object> transform, Continuation<? super Unit> $completion) {
        return CoroutineScopeKt.coroutineScope(new CombineKt$combineInternal$2($this$combineInternal, flows, arrayFactory, transform, (Continuation) null), $completion);
    }

    /* access modifiers changed from: private */
    public static final void onReceive(SelectBuilder<? super Unit> $this$onReceive, boolean isClosed, ReceiveChannel<? extends Object> channel, Function0<Unit> onClosed, Function2<Object, ? super Continuation<? super Unit>, ? extends Object> onReceive) {
        if (!isClosed) {
            $this$onReceive.invoke((SelectClause1<? extends Q>) channel.getOnReceiveOrNull(), (Function2<? super Q, ? super Continuation<? super Object>, ? extends Object>) new CombineKt$onReceive$1(onClosed, onReceive, (Continuation) null));
        }
    }

    /* access modifiers changed from: private */
    public static final ReceiveChannel<Object> asFairChannel(CoroutineScope $this$asFairChannel, Flow<?> flow) {
        return ProduceKt.produce$default($this$asFairChannel, (CoroutineContext) null, 0, new CombineKt$asFairChannel$1(flow, (Continuation) null), 3, (Object) null);
    }
    ...
    public static final ReceiveChannel<Object> asChannel(CoroutineScope $this$asChannel, Flow<?> flow) {
        return ProduceKt.produce$default($this$asChannel, (CoroutineContext) null, 0, new CombineKt$asChannel$1(flow, (Continuation) null), 3, (Object) null);
    }
}

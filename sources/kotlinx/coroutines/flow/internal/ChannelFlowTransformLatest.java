...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    public ChannelFlowTransformLatest(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> transform2, Flow<? extends T> flow, CoroutineContext context, int capacity) {
    ...
    public ChannelFlow<R> create(CoroutineContext context, int capacity) {
        Intrinsics.checkParameterIsNotNull(context, "context");
    ...
    public Object flowCollect(FlowCollector<? super R> collector, Continuation<? super Unit> $completion) {
        if (!DebugKt.getASSERTIONS_ENABLED() || Boxing.boxBoolean(collector instanceof SendingCollector).booleanValue()) {
            return FlowCoroutineKt.flowScope(new ChannelFlowTransformLatest$flowCollect$3(this, collector, (Continuation) null), $completion);
        }

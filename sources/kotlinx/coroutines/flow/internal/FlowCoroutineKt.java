...
public final class FlowCoroutineKt {
    ...
    public static final <T> ReceiveChannel<T> flowProduce(CoroutineScope $this$flowProduce, CoroutineContext context, int capacity, Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull($this$flowProduce, "$this$flowProduce");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(block, "block");
        FlowProduceCoroutine coroutine = new FlowProduceCoroutine(CoroutineContextKt.newCoroutineContext($this$flowProduce, context), ChannelKt.Channel(capacity));

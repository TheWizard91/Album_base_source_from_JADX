...
public final class FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_unsafeTransform$inlined.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new FlowKt__MergeKt$unsafeTransform$$inlined$unsafeFlow$2$lambda$1(collector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

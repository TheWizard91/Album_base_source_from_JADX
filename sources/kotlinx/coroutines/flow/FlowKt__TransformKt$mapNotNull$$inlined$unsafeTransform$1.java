    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_unsafeTransform$inlined.collect(new FlowCollector<T>() {
            public Object emit(Object value, Continuation $completion) {
                ...
                if (transformed != null) {
                    return $receiver.emit(transformed, $completion);
                }
            ...
            public Object emit$$forInline(Object value, Continuation continuation) {
                ...
                Object transformed = this.$transform$inlined$1.invoke(value, continuation);
                if (transformed == null) {
                    return Unit.INSTANCE;
                }
                InlineMarker.mark(0);
                Object emit = $receiver.emit(transformed, continuation);
                InlineMarker.mark(2);
                InlineMarker.mark(1);
                return emit;
            }

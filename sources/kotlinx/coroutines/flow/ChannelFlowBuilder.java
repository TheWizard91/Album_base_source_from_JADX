...
final class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowBuilder(Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block2, CoroutineContext context, int capacity) {
    ...
    public Object collectTo(ProducerScope<? super T> scope, Continuation<? super Unit> $completion) {
        return this.block.invoke(scope, $completion);
    }

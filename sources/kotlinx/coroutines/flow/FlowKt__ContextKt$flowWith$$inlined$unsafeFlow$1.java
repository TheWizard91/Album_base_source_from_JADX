...
public final class FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return FlowKt.buffer(FlowKt.flowOn((Flow) this.$builder$inlined.invoke(FlowKt.buffer(FlowKt.flowOn(this.$source$inlined, $completion.getContext().minusKey(Job.Key)), this.$bufferSize$inlined)), this.$flowContext$inlined), this.$bufferSize$inlined).collect(new FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1$lambda$1(collector), $completion);
    }
}

...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$5 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_unsafeTransform$inlined.collect(new C1880xaa78f19a(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C1880xaa78f19a(collector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

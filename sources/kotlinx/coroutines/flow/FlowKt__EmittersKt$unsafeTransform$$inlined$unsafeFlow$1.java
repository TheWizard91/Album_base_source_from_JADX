...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_unsafeTransform$inlined.collect(new C1792xb062d257(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C1792xb062d257(collector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

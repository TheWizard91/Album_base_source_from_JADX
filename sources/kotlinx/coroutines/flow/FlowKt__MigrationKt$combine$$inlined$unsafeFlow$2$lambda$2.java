...
@DebugMetadata(mo34304c = "kotlinx.coroutines.flow.FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2", mo34305f = "Zip.kt", mo34306i = {0, 0}, mo34307l = {246}, mo34308m = "invokeSuspend", mo34309n = {"$receiver", "it"}, mo34310s = {"L$0", "L$1"})
...
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
        ...
        flowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2.f664p$ = flowCollector;
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            FlowCollector $receiver = this.f664p$;
            Object[] it = this.p$0;

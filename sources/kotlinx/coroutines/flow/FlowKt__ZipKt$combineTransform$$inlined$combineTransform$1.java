...
@DebugMetadata(mo34304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1", mo34305f = "Zip.kt", mo34306i = {0}, mo34307l = {260}, mo34308m = "invokeSuspend", mo34309n = {"$this$flow"}, mo34310s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransform$1.f681p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(mo34304c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1$2", mo34305f = "Zip.kt", mo34306i = {}, mo34307l = {}, mo34308m = "invokeSuspend", mo34309n = {}, mo34310s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1$2 */
    /* compiled from: Zip.kt */
    public static final class C19042 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, Object[] objArr, Continuation<? super Unit> continuation) {
            ...
            C19042 r0 = new C19042(this.this$0, continuation);
            r0.f682p$ = flowCollector;
            r0.p$0 = objArr;
            return r0;
        }

        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return ((C19042) create((FlowCollector) obj, (Object[]) obj2, (Continuation) obj3)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) {
            ...
            if (this.label == 0) {
                ...
                FlowCollector $receiver = this.f682p$;
                Continuation continuation = this;
                Object[] args = this.p$0;
                this.this$0.$transform$inlined.invoke($receiver, args[0], args[1], args[2], this);
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure($result);
            FlowCollector $this$flow = this.f681p$;
            this.L$0 = $this$flow;
            this.label = 1;
            ...
            }, new C19042(this, (Continuation) null), this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        InlineMarker.mark(0);
        CombineKt.combineInternal(this.f681p$, this.$flows, new Function0<Object[]>(this) {
            final /* synthetic */ FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1 this$0;
        ...
        }, new C19042(this, (Continuation) null), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

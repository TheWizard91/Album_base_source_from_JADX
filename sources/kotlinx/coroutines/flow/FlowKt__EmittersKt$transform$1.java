...
@DebugMetadata(mo34304c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$transform$1", mo34305f = "Emitters.kt", mo34306i = {0, 0}, mo34307l = {161}, mo34308m = "invokeSuspend", mo34309n = {"$this$flow", "$this$collect$iv"}, mo34310s = {"L$0", "L$1"})
...
public final class FlowKt__EmittersKt$transform$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__EmittersKt$transform$1.f654p$ = (FlowCollector) obj;
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            FlowCollector $this$flow = this.f654p$;
            Flow $this$collect$iv = this.$this_transform;
            this.L$0 = $this$flow;
            this.L$1 = $this$collect$iv;
            this.label = 1;
            if ($this$collect$iv.collect(new FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1(this, $this$flow), this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        FlowCollector $this$flow = this.f654p$;
        InlineMarker.mark(0);
        this.$this_transform.collect(new FlowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$1(this, $this$flow), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }

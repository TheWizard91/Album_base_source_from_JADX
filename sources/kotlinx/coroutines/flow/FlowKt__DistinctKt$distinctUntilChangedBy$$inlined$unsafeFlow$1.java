...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_distinctUntilChangedBy$inlined.collect(new C1780x59d1cced(collector, previousKey, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        previousKey.element = NullSurrogateKt.NULL;
        InlineMarker.mark(0);
        this.$this_distinctUntilChangedBy$inlined.collect(new C1780x59d1cced(collector, previousKey, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

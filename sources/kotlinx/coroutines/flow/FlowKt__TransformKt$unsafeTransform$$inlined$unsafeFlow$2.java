...
public final class FlowKt__TransformKt$unsafeTransform$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        return this.$this_unsafeTransform$inlined.collect(new C1871xcd9c9e3d(collector, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new C1871xcd9c9e3d(collector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

...
final class ConsumeAsFlow<T> extends ChannelFlow<T> {
    ...
    public ConsumeAsFlow(ReceiveChannel<? extends T> channel2, CoroutineContext context, int capacity) {
    ...
    public Object collectTo(ProducerScope<? super T> scope, Continuation<? super Unit> $completion) {
        return FlowKt.emitAll(new SendingCollector(scope), this.channel, $completion);
    }
    ...
    public Object collect(FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
        ...
        markConsumed();
        return FlowKt.emitAll(collector, this.channel, $completion);
    }

...
public final class FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2 implements Flow<R> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        ...
        Intrinsics.needClassReification();
        return CombineKt.combineInternal(collector, flowArr, new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$1(this), new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2((Continuation) null, this), $completion);
    }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(collector, flowArr, new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$1(this), new FlowKt__MigrationKt$combine$$inlined$unsafeFlow$2$lambda$2((Continuation) null, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);

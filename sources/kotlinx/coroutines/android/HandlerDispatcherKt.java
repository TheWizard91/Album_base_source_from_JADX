...
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper $this$asHandler, boolean async) {
        ...
        try {
            ...
            Handler newInstance = constructor.newInstance(new Object[]{$this$asHandler, null, true});
    ...
    static {
        ...
        try {
            ...
            obj = Result.m1289constructorimpl(new HandlerContext(asHandler(mainLooper, true), "Main"));
        } catch (Throwable th) {

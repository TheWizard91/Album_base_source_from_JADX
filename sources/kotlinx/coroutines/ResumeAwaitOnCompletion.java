...
final class ResumeAwaitOnCompletion<T> extends JobNode<JobSupport> {
    ...
    public void invoke(Throwable cause) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && ((state instanceof Incomplete) ^ 1) == 0) {
            ...
            this.continuation.resumeWith(Result.m1289constructorimpl(unboxState));
        }
    }

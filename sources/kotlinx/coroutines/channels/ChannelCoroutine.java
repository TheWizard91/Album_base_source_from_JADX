...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public boolean cancel(Throwable cause) {
        ...
        if (cause == null || (cancellationException = JobSupport.toCancellationException$default(this, cause, (String) null, 1, (Object) null)) == null) {
        ...
        CancellationException exception = cancellationException;
        this._channel.cancel(exception);
        cancelCoroutine(exception);
        return true;
    }

    public final Object sendFair(E element, Continuation<? super Unit> $completion) {
        Channel<E> channel = this._channel;
        if (channel != null) {
            return ((AbstractSendChannel) channel).sendFair$kotlinx_coroutines_core(element, $completion);
        }

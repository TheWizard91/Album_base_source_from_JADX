...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> $this$broadcast, int capacity, CoroutineStart start) {
        Intrinsics.checkParameterIsNotNull($this$broadcast, "$this$broadcast");
        Intrinsics.checkParameterIsNotNull(start, "start");
        return broadcast(GlobalScope.INSTANCE, Dispatchers.getUnconfined(), capacity, start, ChannelsKt.consumes($this$broadcast), new BroadcastKt$broadcast$1($this$broadcast, (Continuation) null));
    }

...
public final class AbstractChannelKt {
    ...
    public static final <E> Object toResult(Object $this$toResult) {
        if ($this$toResult instanceof Closed) {
            ...
            return ValueOrClosed.m2298constructorimpl(new ValueOrClosed.Closed(((Closed) $this$toResult).closeCause));
        }
        ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
        return ValueOrClosed.m2298constructorimpl($this$toResult);
    }

    /* access modifiers changed from: private */
    public static final <E> Object toResult(Closed<?> $this$toResult) {
        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
        return ValueOrClosed.m2298constructorimpl(new ValueOrClosed.Closed($this$toResult.closeCause));
    }
}

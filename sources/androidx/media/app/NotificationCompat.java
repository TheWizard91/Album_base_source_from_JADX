...
public class NotificationCompat {
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public RemoteViews generateContentView() {
            ...
            view.removeAllViews(C2136R.C2139id.media_actions);
            if (numActionsInCompact > 0) {
                int i = 0;
                while (i < numActionsInCompact) {
                    if (i < numActions) {
                        view.addView(C2136R.C2139id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                        i++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                view.setViewVisibility(C2136R.C2139id.end_padder, 8);
                view.setViewVisibility(C2136R.C2139id.cancel_action, 0);
                view.setOnClickPendingIntent(C2136R.C2139id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C2136R.C2139id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C2136R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C2136R.C2139id.end_padder, 0);
                view.setViewVisibility(C2136R.C2139id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C2136R.C2140layout.notification_media_action);
            button.setImageViewResource(C2136R.C2139id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C2136R.C2139id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C2136R.C2139id.action0, action.getTitle());
            }
            return button;
        }
        ...
        public int getContentViewLayoutResource() {
            return C2136R.C2140layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C2136R.C2139id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C2136R.C2139id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton != 0) {
                big.setViewVisibility(C2136R.C2139id.cancel_action, 0);
                big.setInt(C2136R.C2139id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C2136R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C2136R.C2139id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C2136R.C2139id.cancel_action, 8);
            }
            return big;
        }
        ...
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C2136R.C2140layout.notification_template_big_media_narrow : C2136R.C2140layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C2136R.C2140layout.notification_template_media_custom;
            }
        ...
        /* access modifiers changed from: package-private */
        public int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C2136R.C2140layout.notification_template_big_media_narrow_custom : C2136R.C2140layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C2136R.C2137color.notification_material_background_media_default_color);
            }
            views.setInt(C2136R.C2139id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
}

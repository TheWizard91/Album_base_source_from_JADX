...
public final class MultiDex {
    ...
    private static void doInstallation(android.content.Context r9, java.io.File r10, java.io.File r11, java.lang.String r12, java.lang.String r13, boolean r14) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.reflect.InvocationTargetException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.ClassNotFoundException, java.lang.InstantiationException {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r0.contains(r10)     // Catch:{ all -> 0x00be }
            if (r1 == 0) goto L_0x000b
            monitor-exit(r0)     // Catch:{ all -> 0x00be }
            return
        L_0x000b:
            r0.add(r10)     // Catch:{ all -> 0x00be }
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x00be }
            r2 = 20
            ...
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x00be }
            int r4 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x00be }
            java.lang.String r4 = ": SDK version higher than "
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r2 = r3.append(r2)     // Catch:{ all -> 0x00be }
            java.lang.String r3 = " should be backed by "
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00be }
            ...
            java.lang.String r3 = java.lang.System.getProperty(r3)     // Catch:{ all -> 0x00be }
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00be }
            java.lang.String r3 = "\""
            java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00be }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x00be }
            android.util.Log.w(r1, r2)     // Catch:{ all -> 0x00be }
        L_0x005a:
            java.lang.ClassLoader r1 = r9.getClassLoader()     // Catch:{ RuntimeException -> 0x00b4 }
            ...
            android.util.Log.e(r2, r3)     // Catch:{ all -> 0x00be }
            monitor-exit(r0)     // Catch:{ all -> 0x00be }
            return
        L_0x006a:
        ...
        L_0x006e:
            ...
            android.util.Log.w(r3, r4, r2)     // Catch:{ all -> 0x00be }
        L_0x0076:
            java.io.File r2 = getDexDir(r9, r11, r12)     // Catch:{ all -> 0x00be }
            androidx.multidex.MultiDexExtractor r3 = new androidx.multidex.MultiDexExtractor     // Catch:{ all -> 0x00be }
            r3.<init>(r10, r2)     // Catch:{ all -> 0x00be }
            r4 = 0
            r5 = 0
            java.util.List r5 = r3.load(r9, r13, r5)     // Catch:{ all -> 0x00ab }
            installSecondaryDexes(r1, r2, r5)     // Catch:{ IOException -> 0x0089 }
            goto L_0x009c
        L_0x0089:
            r6 = move-exception
            ...
            android.util.Log.w(r7, r8, r6)     // Catch:{ all -> 0x00ab }
            r7 = 1
            java.util.List r7 = r3.load(r9, r13, r7)     // Catch:{ all -> 0x00ab }
            r5 = r7
            installSecondaryDexes(r1, r2, r5)     // Catch:{ all -> 0x00ab }
        L_0x009c:
        ...
        L_0x00b4:
            ...
            android.util.Log.w(r2, r3, r1)     // Catch:{ all -> 0x00be }
            monitor-exit(r0)     // Catch:{ all -> 0x00be }
            return
        L_0x00be:
            r1 = move-exception
    ...
    private static final class C0340V4 {
        private C0340V4() {
        }

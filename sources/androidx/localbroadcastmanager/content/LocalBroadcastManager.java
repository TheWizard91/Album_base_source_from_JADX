...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r19) {
        /*
            ...
            monitor-enter(r3)
            java.lang.String r5 = r19.getAction()     // Catch:{ all -> 0x0187 }
            android.content.Context r0 = r1.mAppContext     // Catch:{ all -> 0x0187 }
            android.content.ContentResolver r0 = r0.getContentResolver()     // Catch:{ all -> 0x0187 }
            java.lang.String r0 = r2.resolveTypeIfNeeded(r0)     // Catch:{ all -> 0x0187 }
            android.net.Uri r8 = r19.getData()     // Catch:{ all -> 0x0187 }
            java.lang.String r4 = r19.getScheme()     // Catch:{ all -> 0x0187 }
            r11 = r4
            java.util.Set r9 = r19.getCategories()     // Catch:{ all -> 0x0187 }
            int r4 = r19.getFlags()     // Catch:{ all -> 0x0187 }
            r4 = r4 & 8
        ...
        L_0x002e:
            ...
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r6 = r6.append(r0)     // Catch:{ all -> 0x0187 }
            java.lang.String r7 = " scheme "
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r6 = r6.append(r11)     // Catch:{ all -> 0x0187 }
            java.lang.String r7 = " of intent "
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r6 = r6.append(r2)     // Catch:{ all -> 0x0187 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0187 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0187 }
        L_0x005d:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r4 = r1.mActions     // Catch:{ all -> 0x0187 }
            java.lang.String r6 = r19.getAction()     // Catch:{ all -> 0x0187 }
            java.lang.Object r4 = r4.get(r6)     // Catch:{ all -> 0x0187 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0187 }
            r15 = r4
            ...
            java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r6 = r6.append(r15)     // Catch:{ all -> 0x0187 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0187 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0187 }
        L_0x0086:
            r4 = 0
            ...
            r7 = r6
        L_0x008a:
            int r4 = r15.size()     // Catch:{ all -> 0x0187 }
            if (r7 >= r4) goto L_0x014d
            java.lang.Object r4 = r15.get(r7)     // Catch:{ all -> 0x0187 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r4 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0187 }
            r6 = r4
            ...
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ all -> 0x0187 }
            android.content.IntentFilter r13 = r6.filter     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ all -> 0x0187 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x0187 }
            android.util.Log.v(r4, r12)     // Catch:{ all -> 0x0187 }
        L_0x00b3:
            boolean r4 = r6.broadcasting     // Catch:{ all -> 0x0187 }
        ...
        L_0x00c7:
            ...
            goto L_0x0146
        L_0x00ce:
            android.content.IntentFilter r4 = r6.filter     // Catch:{ all -> 0x0187 }
            ...
            r0 = r10
            r10 = r12
            int r4 = r4.match(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0187 }
            ...
            java.lang.StringBuilder r7 = r7.append(r10)     // Catch:{ all -> 0x0187 }
            java.lang.String r10 = java.lang.Integer.toHexString(r4)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r7 = r7.append(r10)     // Catch:{ all -> 0x0187 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0187 }
            android.util.Log.v(r6, r7)     // Catch:{ all -> 0x0187 }
        L_0x00ff:
        ...
        L_0x0108:
            r10 = r0
        L_0x0109:
            r10.add(r13)     // Catch:{ all -> 0x0187 }
            r0 = 1
            r13.broadcasting = r0     // Catch:{ all -> 0x0187 }
            goto L_0x0147
        L_0x0110:
        ...
        L_0x012e:
            ...
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x0187 }
            r10.<init>()     // Catch:{ all -> 0x0187 }
            java.lang.String r12 = "  Filter did not match: "
            java.lang.StringBuilder r10 = r10.append(r12)     // Catch:{ all -> 0x0187 }
            java.lang.StringBuilder r10 = r10.append(r6)     // Catch:{ all -> 0x0187 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x0187 }
            android.util.Log.v(r7, r10)     // Catch:{ all -> 0x0187 }
        L_0x0146:
            r10 = r0
        L_0x0147:
            int r7 = r16 + 1
        ...
        L_0x014d:
            ...
            r4 = 0
        L_0x0155:
            int r6 = r0.size()     // Catch:{ all -> 0x0187 }
            if (r4 >= r6) goto L_0x0167
            java.lang.Object r6 = r0.get(r4)     // Catch:{ all -> 0x0187 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r6 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r6     // Catch:{ all -> 0x0187 }
            r7 = 0
            r6.broadcasting = r7     // Catch:{ all -> 0x0187 }
            int r4 = r4 + 1
            goto L_0x0155
        L_0x0167:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r4 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0187 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r6 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0187 }
            r6.<init>(r2, r0)     // Catch:{ all -> 0x0187 }
            r4.add(r6)     // Catch:{ all -> 0x0187 }
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0187 }
            r6 = 1
            boolean r4 = r4.hasMessages(r6)     // Catch:{ all -> 0x0187 }
            if (r4 != 0) goto L_0x017f
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0187 }
            r4.sendEmptyMessage(r6)     // Catch:{ all -> 0x0187 }
        L_0x017f:
            monitor-exit(r3)     // Catch:{ all -> 0x0187 }
            r3 = 1
            return r3
        L_0x0182:
            r17 = r0

...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(this.mContext).inflate(C2038R.C2042layout.browser_actions_context_menu_row, (ViewGroup) null);
            viewHolder = new ViewHolderItem();
            viewHolder.mIcon = (ImageView) convertView.findViewById(C2038R.C2041id.browser_actions_menu_item_icon);
            viewHolder.mText = (TextView) convertView.findViewById(C2038R.C2041id.browser_actions_menu_item_text);

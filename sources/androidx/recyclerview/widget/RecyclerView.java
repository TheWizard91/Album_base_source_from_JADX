...
import androidx.recyclerview.C2219R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C2219R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C2219R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C2219R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C2219R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C2219R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C2219R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C2219R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C2219R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C2219R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C2219R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C2219R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C04591 r0 = new ViewBoundsCheck.Callback() {
            ...
            C04602 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int index) {
                    return LayoutManager.this.getChildAt(index);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C2219R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C2219R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C2219R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C2219R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C2219R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C2219R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C2219R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C2219R.dimen.fastscroll_margin));
    }

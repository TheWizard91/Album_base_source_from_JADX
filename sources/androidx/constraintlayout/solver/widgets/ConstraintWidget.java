...
public class ConstraintWidget {
    ...
    public String toString() {
        String str = "";
        StringBuilder append = new StringBuilder().append(this.mType != null ? "type: " + this.mType + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : str);
        if (this.mDebugName != null) {
            str = "id: " + this.mDebugName + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
        }
        return append.append(str).append("(").append(this.f13mX).append(", ").append(this.f14mY).append(") - (").append(this.mWidth).append(" x ").append(this.mHeight).append(") wrap: (").append(this.mWrapWidth).append(" x ").append(this.mWrapHeight).append(")").toString();
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        int i = C01471.f15x4c44d048[type.ordinal()];
        if (i == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C01471.f15x4c44d048[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int i7 = C01471.f16xdde91696[dimensionBehaviour.ordinal()];

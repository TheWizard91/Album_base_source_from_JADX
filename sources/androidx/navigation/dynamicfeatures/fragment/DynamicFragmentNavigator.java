...
public final class DynamicFragmentNavigator extends FragmentNavigator {
    ...
    public DynamicFragmentNavigator(Context context, FragmentManager manager, int containerId, DynamicInstallManager installManager2) {
    ...
    public static final class Destination extends FragmentNavigator.Destination {
        ...
        public void onInflate(Context context, AttributeSet attrs) {
            ...
            int[] attrs$iv = C2174R.styleable.DynamicFragmentNavigator;
            Intrinsics.checkExpressionValueIsNotNull(attrs$iv, "R.styleable.DynamicFragmentNavigator");
            TypedArray $this$withStyledAttributes = context.obtainStyledAttributes(attrs, attrs$iv, 0, 0);
            this.moduleName = $this$withStyledAttributes.getString(C2174R.styleable.DynamicFragmentNavigator_moduleName);

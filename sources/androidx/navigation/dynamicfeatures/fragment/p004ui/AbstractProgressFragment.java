...
public abstract class AbstractProgressFragment extends Fragment {
    ...
    @Metadata(mo33669bv = {1, 0, 3}, mo33670d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000¨\u0006\u0007"}, mo33671d2 = {"Landroidx/navigation/dynamicfeatures/fragment/ui/AbstractProgressFragment$Companion;", "", "()V", "INSTALL_REQUEST_CODE", "", "TAG", "", "navigation-dynamic-features-fragment_release"}, mo33672k = 1, mo33673mv = {1, 1, 16})
    /* renamed from: androidx.navigation.dynamicfeatures.fragment.ui.AbstractProgressFragment$Companion */
    /* compiled from: AbstractProgressFragment.kt */
    ...
    public void onResume() {
        ...
        DynamicInstallMonitor monitor = getInstallViewModel().getInstallMonitor();
        if (monitor == null) {
            Log.i(TAG, "onResume: monitor is null, navigating");
            navigate();
            monitor = getInstallViewModel().getInstallMonitor();
        }
        if (monitor != null) {
            Log.i(TAG, "onResume: monitor is now not null, observing");
            monitor.getStatus().observe(this, new StateObserver(this, monitor));
        }
    }
    ...
    public final void navigate() {
        ...
        FragmentKt.findNavController(this).navigate(getDestinationId(), getDestinationArgs(), (NavOptions) null, (Navigator.Extras) new DynamicExtras(installMonitor, (Navigator.Extras) null, 2, (DefaultConstructorMarker) null));
        ...
        getInstallViewModel().setInstallMonitor(installMonitor);
    }
    ...
    private final class StateObserver implements Observer<SplitInstallSessionState> {
        ...
        public StateObserver(AbstractProgressFragment $outer, DynamicInstallMonitor monitor2) {
                ...
                switch (sessionState.status()) {
                    ...
                    case 8:
                        try {
                            ...
                            PendingIntent resolutionIntent = sessionState.resolutionIntent();

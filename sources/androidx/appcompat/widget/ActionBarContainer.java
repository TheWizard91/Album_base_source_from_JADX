...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C2018R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C2018R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C2018R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C2018R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C2018R.C2021id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C2018R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C2018R.C2021id.action_bar);
        this.mContextView = findViewById(C2018R.C2021id.action_context_bar);
    }

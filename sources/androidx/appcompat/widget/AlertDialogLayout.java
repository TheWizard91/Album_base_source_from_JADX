    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C2018R.C2021id.topPanel) {
                    topPanel = child;
                } else if (id == C2018R.C2021id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C2018R.C2021id.contentPanel && id != C2018R.C2021id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }

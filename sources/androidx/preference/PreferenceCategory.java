...
public class PreferenceCategory extends PreferenceGroup {
    ...
    public PreferenceCategory(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, C2211R.attr.preferenceCategoryStyle, 16842892));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (getContext().getTheme().resolveAttribute(C2211R.attr.colorAccent, value, true) && (titleView = (TextView) holder.findViewById(16908310)) != null && titleView.getCurrentTextColor() == ContextCompat.getColor(getContext(), C2211R.C2212color.preference_fallback_accent_color)) {

...
@DebugMetadata(mo34304c = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenCreated$1", mo34305f = "Lifecycle.kt", mo34306i = {0}, mo34307l = {74}, mo34308m = "invokeSuspend", mo34309n = {"$this$launch"}, mo34310s = {"L$0"})
...
final class LifecycleCoroutineScope$launchWhenCreated$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        lifecycleCoroutineScope$launchWhenCreated$1.f29p$ = (CoroutineScope) obj;
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        if (i == 0) {
            ...
            CoroutineScope $this$launch = this.f29p$;

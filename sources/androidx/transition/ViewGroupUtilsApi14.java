...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            C05161 r0 = new LayoutTransition() {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C2240R.C2243id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C2240R.C2243id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C2240R.C2243id.transition_layout_save, (Object) null);

...
public abstract class FragmentTransaction {
    ...
    static final class C0234Op {
        ...
        C0234Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0234Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0234Op(opcmd, fragment));
    }

...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, Fragment fragment, boolean enter) {
        ...
        if (!(container == null || container.getTag(C2082R.C2085id.visible_removing_fragment_view_tag) == null)) {
            container.setTag(C2082R.C2085id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int transit, boolean enter) {
        if (transit == 4097) {
            return enter ? C2082R.anim.fragment_open_enter : C2082R.anim.fragment_open_exit;
        } else if (transit == 4099) {
            return enter ? C2082R.anim.fragment_fade_enter : C2082R.anim.fragment_fade_exit;
        } else if (transit != 8194) {
            return -1;
        } else {
            return enter ? C2082R.anim.fragment_close_enter : C2082R.anim.fragment_close_exit;
        }
    }

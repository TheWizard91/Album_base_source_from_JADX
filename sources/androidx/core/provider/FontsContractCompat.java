...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008a, code lost:
        sBackgroundThread.postAndReply(r2, new androidx.core.provider.FontsContractCompat.C01683());
     */
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri fileBaseUri = new Uri.Builder().scheme("content").authority(str).appendPath(UriUtil.LOCAL_FILE_SCHEME).build();
        Cursor cursor2 = null;
        try {
            int i = 0;

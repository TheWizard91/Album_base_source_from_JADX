package p017de.hdodenhof.circleimageview;
...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = 0;
        this.mCircleBackgroundColor = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C2615R.styleable.CircleImageView, defStyle, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C2615R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = a.getColor(C2615R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(C2615R.styleable.CircleImageView_civ_border_overlay, false);
        this.mCircleBackgroundColor = a.getColor(C2615R.styleable.CircleImageView_civ_circle_background_color, 0);
        a.recycle();
        init();
    }
    ...
    private boolean inTouchableArea(float x, float y) {
        if (!this.mBorderRect.isEmpty() && Math.pow((double) (x - this.mBorderRect.centerX()), 2.0d) + Math.pow((double) (y - this.mBorderRect.centerY()), 2.0d) > Math.pow((double) this.mBorderRadius, 2.0d)) {
            return false;
        }
        return true;
    }

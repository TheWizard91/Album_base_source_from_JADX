...
public final class MediaControllerCompat {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        if (activity instanceof ComponentActivity) {
            ...
            try {
                return new MediaControllerCompat((Context) activity, MediaSessionCompat.Token.fromToken(controllerFwk.getSessionToken()));
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public MediaControllerImplApi21(Context context, MediaSessionCompat.Token sessionToken) throws RemoteException {
            ...
            MediaController mediaController = new MediaController(context, (MediaSession.Token) sessionToken.getToken());

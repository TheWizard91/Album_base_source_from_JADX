...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent, Bundle sessionInfo) {
        this(context, tag, mbrComponent, mbrIntent, sessionInfo, (VersionedParcelable) null);
    }
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                MediaSessionImpl impl;
                if (msg.what == 1 && (impl = (MediaSessionImpl) Callback.this.mSessionImpl.get()) != null) {
        ...
        private class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            public void onCommand(java.lang.String r7, android.os.Bundle r8, android.os.ResultReceiver r9) {
                /*
                    r6 = this;
                    android.support.p000v4.media.session.MediaSessionCompat.ensureClassLoader(r8)
                ...
                L_0x0031:
                    androidx.core.app.BundleCompat.putBinder(r2, r5, r1)     // Catch:{ BadParcelableException -> 0x00ca }
            ...
            public void setCurrentControllerInfo() {
                if (Build.VERSION.SDK_INT < 28) {
                    MediaSessionImpl sessionImpl = Callback.this.mSessionImpl != null ? (MediaSessionImpl) Callback.this.mSessionImpl.get() : null;
                    if (sessionImpl != null) {
            ...
            public void clearCurrentControllerInfo() {
                MediaSessionImpl sessionImpl = Callback.this.mSessionImpl != null ? (MediaSessionImpl) Callback.this.mSessionImpl.get() : null;
                if (sessionImpl != null) {
                    sessionImpl.setCurrentControllerInfo((MediaSessionManager.RemoteUserInfo) null);
                }
            }
    ...
    public static final class Token implements Parcelable {
        ...
        Token(Object inner) {
            this(inner, (IMediaSession) null, (VersionedParcelable) null);
        }

        Token(Object inner, IMediaSession extraBinder) {
            this(inner, extraBinder, (VersionedParcelable) null);
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public QueueItem(MediaDescriptionCompat description, long id) {
            this((MediaSession.QueueItem) null, description, id);
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void sendCommand(String command, Bundle args, ResultReceiverWrapper cb) {
                postToHandler(1, (Object) new Command(command, args, cb == null ? null : cb.mResultReceiver));
            }
            ...
            public void setPlaybackSpeed(float speed) throws RemoteException {
                postToHandler(32, (Object) Float.valueOf(speed));
            }

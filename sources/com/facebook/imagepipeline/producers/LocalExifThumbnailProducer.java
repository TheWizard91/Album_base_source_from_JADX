...
public class LocalExifThumbnailProducer implements ThumbnailProducer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final StatefulProducerRunnable cancellableProducerRunnable = new StatefulProducerRunnable<EncodedImage>(consumer, listener, producerContext, PRODUCER_NAME) {
            ...
            public Map<String, String> getExtraMapOnSuccess(EncodedImage result) {
                return ImmutableMap.m32of(LocalExifThumbnailProducer.CREATED_THUMBNAIL, Boolean.toString(result != null));
            }
        };
    ...
    public ExifInterface getExifInterface(Uri uri) {
        ...
        try {
            ...
            FLog.m56e((Class<?>) LocalExifThumbnailProducer.class, "StackOverflowError in ExifInterface constructor");
        }
    }
    ...
    public EncodedImage buildEncodedImage(PooledByteBuffer imageBytes, ExifInterface exifInterface) {
        ...
        CloseableReference<PooledByteBuffer> closeableByteBuffer = CloseableReference.m124of(imageBytes);
        try {

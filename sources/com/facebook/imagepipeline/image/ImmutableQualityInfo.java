...
public class ImmutableQualityInfo implements QualityInfo {
    public static final QualityInfo FULL_QUALITY = m132of(Integer.MAX_VALUE, true, true);
    ...
    /* renamed from: of */
    public static QualityInfo m132of(int quality, boolean isOfGoodEnoughQuality, boolean isOfFullQuality) {

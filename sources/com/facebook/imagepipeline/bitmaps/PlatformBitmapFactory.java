...
public abstract class PlatformBitmapFactory {
    ...
    public CloseableReference<Bitmap> createScaledBitmap(Bitmap source, int destinationWidth, int destinationHeight, boolean filter) {
        return createScaledBitmap(source, destinationWidth, destinationHeight, filter, (Object) null);
    }
    ...
    public CloseableReference<Bitmap> createBitmap(Bitmap source, int x, int y, int width, int height, @Nullable Matrix matrix, boolean filter, @Nullable Object callerContext) {
        ...
        Rect srcRectangle = new Rect(i, i2, i + i3, i2 + i4);
        RectF dstRectangle = new RectF(0.0f, 0.0f, (float) i3, (float) i4);
        ...
        if (matrix2 == null) {
            ...
            matrix2.mapRect(deviceRectangle, dstRectangle);
            ...
            setPropertyFromSourceBitmap(bitmap, bitmapRef.get());
            ...
            canvas.drawBitmap(bitmap, srcRectangle, dstRectangle, paint);
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap source) {
        ...
        int i = C06991.$SwitchMap$android$graphics$Bitmap$Config[sourceConfig.ordinal()];
        if (i == 1) {

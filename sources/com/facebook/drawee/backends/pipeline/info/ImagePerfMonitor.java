...
public class ImagePerfMonitor {
    ...
    public void updateImageRequestData(AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> pipelineDraweeControllerBuilder) {
        this.mImagePerfState.setControllerImageRequests(pipelineDraweeControllerBuilder.getImageRequest(), pipelineDraweeControllerBuilder.getLowResImageRequest(), (ImageRequest[]) pipelineDraweeControllerBuilder.getFirstAvailableImageRequests());
    }

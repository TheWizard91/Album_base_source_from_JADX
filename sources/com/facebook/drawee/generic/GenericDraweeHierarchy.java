...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    GenericDraweeHierarchy(GenericDraweeHierarchyBuilder builder) {
        ...
        layers[0] = buildBranch(builder.getBackground(), (ScalingUtils.ScaleType) null);
        layers[1] = buildBranch(builder.getPlaceholderImage(), builder.getPlaceholderImageScaleType());
        layers[2] = buildActualImageBranch(forwardingDrawable, builder.getActualImageScaleType(), builder.getActualImageFocusPoint(), builder.getActualImageColorFilter());
        ...
        if (numOverlays > 0) {
            ...
            if (builder.getOverlays() != null) {
                for (Drawable overlay : builder.getOverlays()) {
                    layers[index + 6] = buildBranch(overlay, (ScalingUtils.ScaleType) null);
                    index++;
                }
            } else {
                index = 1;
            ...
            if (builder.getPressedStateOverlay() != null) {
                layers[index + 6] = buildBranch(builder.getPressedStateOverlay(), (ScalingUtils.ScaleType) null);
            }
        }
        FadeDrawable fadeDrawable = new FadeDrawable(layers);
    ...
    /* JADX WARNING: type inference failed for: r1v5, types: [android.graphics.drawable.Drawable] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.facebook.drawee.drawable.DrawableParent getParentDrawableAtIndex(int r3) {
        /*
            r2 = this;
            com.facebook.drawee.drawable.FadeDrawable r0 = r2.mFadeDrawable
            com.facebook.drawee.drawable.DrawableParent r0 = r0.getDrawableParentForIndex(r3)
            android.graphics.drawable.Drawable r1 = r0.getDrawable()
            boolean r1 = r1 instanceof com.facebook.drawee.drawable.MatrixDrawable
            if (r1 == 0) goto L_0x0015
            android.graphics.drawable.Drawable r1 = r0.getDrawable()
            r0 = r1
            com.facebook.drawee.drawable.MatrixDrawable r0 = (com.facebook.drawee.drawable.MatrixDrawable) r0
        L_0x0015:
            android.graphics.drawable.Drawable r1 = r0.getDrawable()
            boolean r1 = r1 instanceof com.facebook.drawee.drawable.ScaleTypeDrawable

...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream is) throws IOException {
        ...
        return new Pair<>(Integer.valueOf((((data2 & 63) << 8) | (((byte) is.read()) & 255)) + 1), Integer.valueOf(((((((byte) is.read()) & 255) & 15) << 10) | ((((byte) is.read()) & 255) << 2) | ((data2 & JfifUtil.MARKER_SOFn) >> 6)) + 1));
    }
    ...
    private static int getInt(InputStream is) throws IOException {
        return ((((byte) is.read()) << Ascii.CAN) & -16777216) | ((((byte) is.read()) << Ascii.DLE) & 16711680) | ((((byte) is.read()) << 8) & 65280) | (((byte) is.read()) & 255);
    }
    ...
    private static int read3Bytes(InputStream is) throws IOException {
        ...
        return ((getByte(is) << Ascii.DLE) & 16711680) | ((getByte(is) << 8) & 65280) | (byte1 & 255);
    }

    ...
    public void execute(Runnable runnable) {
        if (runnable == null) {
            ...
            if (queueSize > maxSize && this.mMaxQueueSize.compareAndSet(maxSize, queueSize)) {
                FLog.m82v(TAG, "%s: max pending work in queue = %d", (Object) this.mName, (Object) Integer.valueOf(queueSize));
            }
            startWorkerIfNeeded();
        } else {
    ...
    public void startWorkerIfNeeded() {
        ...
        while (currentCount < this.mMaxConcurrency) {
            ...
            if (this.mPendingWorkers.compareAndSet(currentCount, updatedCount)) {
                FLog.m83v(TAG, "%s: starting worker %d of %d", (Object) this.mName, (Object) Integer.valueOf(updatedCount), (Object) Integer.valueOf(this.mMaxConcurrency));
                this.mExecutor.execute(this.mTaskRunner);
                return;
            }
            FLog.m81v(TAG, "%s: race in startWorkerIfNeeded; retrying", (Object) this.mName);
        ...
        public void run() {
            ...
            try {
                ...
                if (runnable != null) {
                    ...
                    FLog.m81v((Class<?>) ConstrainedExecutorService.TAG, "%s: Worker has nothing to run", (Object) ConstrainedExecutorService.this.mName);
                }
                if (isEmpty) {
                    FLog.m82v((Class<?>) ConstrainedExecutorService.TAG, "%s: worker finished; %d workers left", (Object) ConstrainedExecutorService.this.mName, (Object) Integer.valueOf(access$400.decrementAndGet()));
                }
            } finally {
                ...
                if (!ConstrainedExecutorService.this.mWorkQueue.isEmpty()) {
                    ...
                    FLog.m82v((Class<?>) ConstrainedExecutorService.TAG, "%s: worker finished; %d workers left", (Object) ConstrainedExecutorService.this.mName, (Object) Integer.valueOf(workers));
                }
            }
        }
    }

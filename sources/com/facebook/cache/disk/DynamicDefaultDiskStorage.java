...
public class DynamicDefaultDiskStorage implements DiskStorage {
    ...
    static class State {
        ...
        State(@Nullable File rootDirectory2, @Nullable DiskStorage delegate2) {
    ...
    public void purgeUnexpectedResources() {
        try {
            ...
            FLog.m57e(TAG, "purgeUnexpectedResources", (Throwable) ioe);
        }
    }
    ...
    public void createRootDirectoryIfNecessary(File rootDirectory) throws IOException {
        try {
            ...
            FLog.m41d(TAG, "Created cache directory %s", (Object) rootDirectory.getAbsolutePath());

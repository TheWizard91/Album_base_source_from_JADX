...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f55ix = readShort();
        this.header.currentFrame.f56iy = readShort();
        this.header.currentFrame.f54iw = readShort();
        this.header.currentFrame.f53ih = readShort();
        int packed = read();
        boolean z = false;

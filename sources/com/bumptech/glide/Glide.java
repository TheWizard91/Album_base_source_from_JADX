...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory2, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, boolean isLoggingRequestOriginsEnabled, boolean isImageDecoderEnabledForBitmaps) {
        ...
        registry2.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool3)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, streamBitmapDecoder).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, byteBufferBitmapDecoder);
        ...
        ResourceDecoder<InputStream, Bitmap> resourceDecoder2 = byteBufferBitmapDecoder3;
        ...
        ResourceDecoder<ByteBuffer, Bitmap> resourceDecoder3 = byteBufferBitmapDecoder;
        ...
        ResourceLoader.StreamFactory streamFactory = resourceLoaderStreamFactory3;
        this.glideContext = new GlideContext(context, arrayPool2, registry2, new ImageViewTargetFactory(), defaultRequestOptionsFactory2, defaultTransitionOptions, defaultRequestListeners, engine2, isLoggingRequestOriginsEnabled, logLevel);
    }

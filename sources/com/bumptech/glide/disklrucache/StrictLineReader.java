...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f50CR = 13;

    /* renamed from: LF */
    private static final byte f51LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f52in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f52in;
        byte[] bArr = this.buf;

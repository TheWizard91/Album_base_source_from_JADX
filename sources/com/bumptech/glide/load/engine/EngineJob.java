...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r4 = r3.next();
        r4.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r8, r4.f62cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r7 = r4.f62cb
            r6.<init>(r7)
            r5.execute(r6)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r3 = r0.next();
        r3.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r7, r3.f62cb));
     */
    ...
    public void notifyCallbacksOfException() {
        ...
        L_0x0039:
            ...
            com.bumptech.glide.request.ResourceCallback r6 = r3.f62cb
            r5.<init>(r6)
            r4.execute(r5)
            goto L_0x0039
        L_0x0052:
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f60cb;
        ...
        public void run() {
            synchronized (this.f60cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f60cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f60cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        public void run() {
            synchronized (this.f61cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f61cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f61cb);
                        EngineJob.this.removeCallback(this.f61cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        public boolean equals(Object o) {
            if (o instanceof ResourceCallbackAndExecutor) {
                return this.f62cb.equals(((ResourceCallbackAndExecutor) o).f62cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f62cb.hashCode();
        }
    }

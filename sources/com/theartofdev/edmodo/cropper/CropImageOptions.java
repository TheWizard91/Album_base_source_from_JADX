...
public class CropImageOptions implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.showCropOverlay ? (byte) 1 : 0);
        dest.writeByte(this.showProgressBar ? (byte) 1 : 0);
        dest.writeByte(this.autoZoomEnabled ? (byte) 1 : 0);
        dest.writeByte(this.multiTouchEnabled ? (byte) 1 : 0);
        dest.writeInt(this.maxZoom);
        dest.writeFloat(this.initialCropWindowPaddingRatio);
        dest.writeByte(this.fixAspectRatio ? (byte) 1 : 0);
        ...
        dest.writeByte(this.allowRotation ? (byte) 1 : 0);
        dest.writeByte(this.allowFlipping ? (byte) 1 : 0);
        dest.writeByte(this.allowCounterRotation ? (byte) 1 : 0);
        dest.writeInt(this.rotationDegrees);
        dest.writeByte(this.flipHorizontally ? (byte) 1 : 0);
        dest.writeByte(this.flipVertically ? (byte) 1 : 0);

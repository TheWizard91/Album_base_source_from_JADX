...
public class DefaultLogger implements Logger {
    ...
    public void onLogMessage(Logger.Level level, String tag, String message, long msTimestamp) {
        if (shouldLog(level, tag)) {
            ...
            int i = C10141.$SwitchMap$com$firebase$client$Logger$Level[level.ordinal()];
            if (i == 1) {
                error(tag, toLog);
            } else if (i == 2) {
                warn(tag, toLog);
    ...
    static /* synthetic */ class C10141 {
        ...
        static {
            ...
            $SwitchMap$com$firebase$client$Logger$Level = iArr;
            try {
                iArr[Logger.Level.ERROR.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$firebase$client$Logger$Level[Logger.Level.WARN.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$firebase$client$Logger$Level[Logger.Level.INFO.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$firebase$client$Logger$Level[Logger.Level.DEBUG.ordinal()] = 4;

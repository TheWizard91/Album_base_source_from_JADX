...
public class QueryParams {
    ...
    public QueryParams startAt(Node indexStartValue2, ChildKey indexStartName2) {
        if (indexStartValue2.isLeafNode() || indexStartValue2.isEmpty()) {
            QueryParams copy = copy();
    ...
    public QueryParams endAt(Node indexEndValue2, ChildKey indexEndName2) {
        if (indexEndValue2.isLeafNode() || indexEndValue2.isEmpty()) {
            QueryParams copy = copy();
    ...
    public Map<String, Object> getWireProtocolParams() {
        ...
        if (num != null) {
            ...
            int i = C09981.$SwitchMap$com$firebase$client$core$view$QueryParams$ViewFrom[viewFromToAdd.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C09981 {
        ...
        static {
            ...
            $SwitchMap$com$firebase$client$core$view$QueryParams$ViewFrom = iArr;
            try {

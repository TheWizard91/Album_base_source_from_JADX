...
public class SyncTree {
    ...
    public List<Event> removeAllEventRegistrations(QuerySpec query, FirebaseError error) {
        return removeEventRegistration(query, (EventRegistration) null, error);
    }

    private List<Event> removeEventRegistration(final QuerySpec query, final EventRegistration eventRegistration, final FirebaseError cancelError) {
        return (List) this.persistenceManager.runInTransaction(new Callable<List<Event>>() {
            ...
            public List<Event> call() {
                ...
                if (maybeSyncPoint == null) {
                    ...
                    Iterator i$2 = path.iterator();
                    while (i$2.hasNext()) {
                        currentTree = currentTree.getChild(i$2.next());
    ...
    public void setupListener(QuerySpec query, View view) {
        ...
        } else if (subtree.getValue().hasCompleteView()) {

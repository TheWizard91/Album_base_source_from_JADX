...
public class ChildrenNode implements Node {
    ...
    public Node updateChild(Path path, Node newChildNode) {
        ...
        if (PriorityUtilities.isValidPriority(newChildNode)) {
    ...
    public boolean equals(java.lang.Object r10) {
        ...
        L_0x0004:
            ...
            return r1
        L_0x0008:
            boolean r2 = r10 instanceof com.firebase.client.snapshot.ChildrenNode
            if (r2 != 0) goto L_0x000d
            return r0
        L_0x000d:
            r2 = r10
            com.firebase.client.snapshot.ChildrenNode r2 = (com.firebase.client.snapshot.ChildrenNode) r2
            com.firebase.client.snapshot.Node r3 = r9.getPriority()
            com.firebase.client.snapshot.Node r4 = r2.getPriority()
            boolean r3 = r3.equals(r4)
            if (r3 != 0) goto L_0x001f
            return r0
        L_0x001f:
            com.firebase.client.collection.ImmutableSortedMap<com.firebase.client.snapshot.ChildKey, com.firebase.client.snapshot.Node> r3 = r9.children
            int r3 = r3.size()
            com.firebase.client.collection.ImmutableSortedMap<com.firebase.client.snapshot.ChildKey, com.firebase.client.snapshot.Node> r4 = r2.children
            int r4 = r4.size()

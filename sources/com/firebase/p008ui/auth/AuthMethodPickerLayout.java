...
public class AuthMethodPickerLayout implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder setMicrosoftButtonId(int microsoftButtonId) {
            this.providersMapping.put(AuthUI.MICROSOFT_PROVIDER, Integer.valueOf(microsoftButtonId));
            return this;
        }

        public Builder setAppleButtonId(int appleButtonId) {
            this.providersMapping.put(AuthUI.APPLE_PROVIDER, Integer.valueOf(appleButtonId));
            return this;
        }

        public Builder setYahooButtonId(int yahooButtonId) {
            this.providersMapping.put(AuthUI.YAHOO_PROVIDER, Integer.valueOf(yahooButtonId));
            return this;
        }
        ...
        public AuthMethodPickerLayout build() {
            if (!this.providersMapping.isEmpty()) {
                for (String key : this.providersMapping.keySet()) {
                    if (!AuthUI.SUPPORTED_PROVIDERS.contains(key) && !AuthUI.SUPPORTED_OAUTH_PROVIDERS.contains(key)) {

...
public final class SpacedEditText extends TextInputEditText {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, C2354R.styleable.SpacedEditText);
        this.mProportion = array.getFloat(C2354R.styleable.SpacedEditText_spacingProportion, 1.0f);
        array.recycle();
    }

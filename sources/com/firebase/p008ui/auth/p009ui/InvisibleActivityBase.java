...
import p023me.zhanghai.android.materialprogressbar.MaterialProgressBar;
...
public class InvisibleActivityBase extends HelperActivityBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C2354R.C2359layout.fui_activity_invisible);
        ...
        params.gravity = 17;
        ((FrameLayout) findViewById(C2354R.C2357id.invisible_frame)).addView(this.mProgressBar, params);
    }

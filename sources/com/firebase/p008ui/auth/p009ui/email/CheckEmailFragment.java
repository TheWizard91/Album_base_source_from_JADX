...
public class CheckEmailFragment extends FragmentBase implements View.OnClickListener, ImeHelper.DonePressedListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        TextView headerText = (TextView) view.findViewById(C2354R.C2357id.header_text);
        if (headerText != null) {
        ...
        TextView termsText = (TextView) view.findViewById(C2354R.C2357id.email_tos_and_pp_text);
        TextView footerText = (TextView) view.findViewById(C2354R.C2357id.email_footer_tos_and_pp_text);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        CheckEmailHandler checkEmailHandler = (CheckEmailHandler) ViewModelProviders.m15of((Fragment) this).get(CheckEmailHandler.class);
        ...
        if (activity instanceof CheckEmailListener) {
            ...
            this.mHandler.getOperation().observe(this, new ResourceObserver<User>(this, C2354R.string.fui_progress_dialog_checking_accounts) {

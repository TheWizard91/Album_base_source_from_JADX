...
import com.firebase.p008ui.auth.p009ui.InvisibleFragmentBase;
...
import com.firebase.p008ui.auth.viewmodel.email.EmailLinkSendEmailHandler;
...
public class EmailLinkFragment extends InvisibleFragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(C2354R.C2359layout.fui_email_link_sign_in_layout, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ScrollView scrollView = (ScrollView) view.findViewById(C2354R.C2357id.top_level_view);
    ...
    private void initHandler() {
        EmailLinkSendEmailHandler emailLinkSendEmailHandler = (EmailLinkSendEmailHandler) ViewModelProviders.m15of((Fragment) this).get(EmailLinkSendEmailHandler.class);
        this.mEmailLinkSendEmailHandler = emailLinkSendEmailHandler;
        emailLinkSendEmailHandler.init(getFlowParams());
        this.mEmailLinkSendEmailHandler.getOperation().observe(this, new ResourceObserver<String>(this, C2354R.string.fui_progress_dialog_sending) {
    ...
    private void setBodyText(View view, String email) {
        String bodyText = getString(C2354R.string.fui_email_link_email_sent, email);
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(bodyText);
        TextHelper.boldAllOccurencesOfText(spannableStringBuilder, bodyText, email);
        ((TextView) view.findViewById(C2354R.C2357id.sign_in_email_sent_text)).setText(spannableStringBuilder);
    }

    private void setOnClickListeners(View view, final String email) {
        view.findViewById(C2354R.C2357id.trouble_signing_in).setOnClickListener(new View.OnClickListener() {

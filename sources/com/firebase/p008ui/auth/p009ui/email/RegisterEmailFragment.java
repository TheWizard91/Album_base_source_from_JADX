...
import com.firebase.p008ui.auth.util.p010ui.fieldvalidators.BaseValidator;
import com.firebase.p008ui.auth.util.p010ui.fieldvalidators.EmailFieldValidator;
import com.firebase.p008ui.auth.util.p010ui.fieldvalidators.NoOpValidator;
import com.firebase.p008ui.auth.util.p010ui.fieldvalidators.PasswordFieldValidator;
import com.firebase.p008ui.auth.util.p010ui.fieldvalidators.RequiredFieldValidator;
import com.firebase.p008ui.auth.viewmodel.ResourceObserver;
import com.firebase.p008ui.auth.viewmodel.email.EmailProviderResponseHandler;
...
public class RegisterEmailFragment extends FragmentBase implements View.OnClickListener, View.OnFocusChangeListener, ImeHelper.DonePressedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EmailProviderResponseHandler emailProviderResponseHandler = (EmailProviderResponseHandler) ViewModelProviders.m15of((Fragment) this).get(EmailProviderResponseHandler.class);
        this.mHandler = emailProviderResponseHandler;
        emailProviderResponseHandler.init(getFlowParams());
        this.mHandler.getOperation().observe(this, new ResourceObserver<IdpResponse>(this, C2354R.string.fui_progress_dialog_signing_up) {
            ...
            public void onFailure(Exception e) {
                if (e instanceof FirebaseAuthWeakPasswordException) {
                    RegisterEmailFragment.this.mPasswordInput.setError(RegisterEmailFragment.this.getResources().getQuantityString(C2354R.plurals.fui_error_weak_password, C2354R.integer.fui_min_password_length));
                } else if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    RegisterEmailFragment.this.mEmailInput.setError(RegisterEmailFragment.this.getString(C2354R.string.fui_invalid_email_address));
                    ...
                    RegisterEmailFragment.this.mEmailInput.setError(RegisterEmailFragment.this.getString(C2354R.string.fui_email_account_creation_error));
                }
            }
        });
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(C2354R.C2359layout.fui_register_email_layout, container, false);
    }

    public void onViewCreated(View view, Bundle savedInstanceState) {
        this.mNextButton = (Button) view.findViewById(C2354R.C2357id.button_create);
        ...
        this.mNameEditText = (EditText) view.findViewById(C2354R.C2357id.name);
        this.mPasswordEditText = (EditText) view.findViewById(C2354R.C2357id.password);
        this.mEmailInput = (TextInputLayout) view.findViewById(C2354R.C2357id.email_layout);
        this.mPasswordInput = (TextInputLayout) view.findViewById(C2354R.C2357id.password_layout);
        TextInputLayout nameInput = (TextInputLayout) view.findViewById(C2354R.C2357id.name_layout);
        ...
        this.mPasswordFieldValidator = new PasswordFieldValidator(this.mPasswordInput, getResources().getInteger(C2354R.integer.fui_min_password_length));
        this.mNameValidator = requireName ? new RequiredFieldValidator(nameInput, getResources().getString(C2354R.string.fui_missing_first_and_last_name)) : new NoOpValidator(nameInput);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        activity.setTitle(C2354R.string.fui_title_register_email);
    ...
    public void onClick(View view) {
        if (view.getId() == C2354R.C2357id.button_create) {

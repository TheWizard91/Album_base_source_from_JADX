...
import com.firebase.p008ui.auth.p009ui.ProgressView;
import com.firebase.p008ui.auth.util.p010ui.FlowUtils;
...
public abstract class ResourceObserver<T> implements Observer<Resource<T>> {
    ...
    protected ResourceObserver(HelperActivityBase activity) {
        this(activity, (FragmentBase) null, activity, C2354R.string.fui_progress_dialog_loading);
    }
    ...
    protected ResourceObserver(FragmentBase fragment) {
        this((HelperActivityBase) null, fragment, fragment, C2354R.string.fui_progress_dialog_loading);
    }

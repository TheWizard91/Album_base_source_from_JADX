...
public final class PhoneNumberUtils {
    ...
    private static SparseArray<List<String>> createCountryCodeToRegionCodeMap() {
        SparseArray<List<String>> map = new SparseArray<>(215);
        ...
        map.put(JfifUtil.MARKER_SOI, Collections.singletonList("TN"));
        map.put(JfifUtil.MARKER_SOS, Collections.singletonList("LY"));
        ...
        map.put(JfifUtil.MARKER_APP1, Collections.singletonList("CI"));
        ...
        map.put(257, Collections.singletonList("BI"));
        map.put(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_REMOVED, Collections.singletonList("MZ"));
        map.put(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_VOLUME_CHANGED, Collections.singletonList("ZM"));
        map.put(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_PRESENTATION_DISPLAY_CHANGED, Collections.singletonList("MG"));
        map.put(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_SELECTED, Arrays.asList(new String[]{"RE", "YT"}));
        map.put(MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_UNSELECTED, Collections.singletonList("ZW"));
        ...
        map.put(500, Collections.singletonList("FK"));
    ...
    private static void initCountryCodeByIsoMap() {
        ...
        while (true) {
            ...
            if (i < sparseArray.size()) {
                int code = sparseArray.keyAt(i);
                for (String region : sparseArray.get(code)) {

...
public class AuthOperationManager {
    ...
    public Task<AuthResult> safeGenericIdpSignIn(HelperActivityBase activity, OAuthProvider provider, FlowParameters flowParameters) {
        return getScratchAuth(flowParameters).startActivityForSignInWithProvider(activity, provider);
    }
}

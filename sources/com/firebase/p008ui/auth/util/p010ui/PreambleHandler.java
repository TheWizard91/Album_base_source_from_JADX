...
public class PreambleHandler {
    ...
    private PreambleHandler(Context context, FlowParameters parameters, int buttonText) {
        ...
        this.mLinkSpan = new ForegroundColorSpan(ContextCompat.getColor(context, C2354R.C2355color.fui_linkColor));
    }
    ...
    private void initPreamble(int textViewText) {
        ...
        if (withTargets != null) {
            ...
            replaceUrlTarget(TOS_TARGET, C2354R.string.fui_terms_of_service, this.mFlowParameters.termsOfServiceUrl);
            replaceUrlTarget(PP_TARGET, C2354R.string.fui_privacy_policy, this.mFlowParameters.privacyPolicyUrl);
        }
    }
    ...
    private static final class CustomTabsSpan extends URLSpan {
        ...
        public CustomTabsSpan(Context context, String url) {
            ...
            context.getTheme().resolveAttribute(C2354R.attr.colorPrimary, typedValue, true);

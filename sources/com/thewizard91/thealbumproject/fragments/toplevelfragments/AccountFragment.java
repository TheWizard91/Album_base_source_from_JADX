...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C2521R.C2526layout.fragment_account, container, false);
        this.accountContext = container.getContext();
        this.userProfileImage = (CircleImageView) view.findViewById(C2521R.C2524id.account_fragment_user_image);
                ...
                if (documentSnapshot.exists() && (map = documentSnapshot.getData()) != null) {
                    for (Map.Entry<String, Object> entry : map.entrySet()) {
                        if ("profile_image".equals(entry.getKey())) {
                            ...
                            placeholderOption.placeholder((int) C2521R.C2523drawable.default_user_image);

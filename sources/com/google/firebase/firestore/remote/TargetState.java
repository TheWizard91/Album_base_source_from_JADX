...
final class TargetState {
    ...
    public TargetChange toTargetChange() {
        ...
        for (Map.Entry<DocumentKey, DocumentViewChange.Type> entry : this.documentChanges.entrySet()) {
            ...
            int i = C39191.f1733x33862af7[changeType.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C39191 {
        ...
        static {
            ...
            try {
                f1733x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1733x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 3;

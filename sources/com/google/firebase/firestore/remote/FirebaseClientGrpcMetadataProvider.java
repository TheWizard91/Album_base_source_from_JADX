...
public class FirebaseClientGrpcMetadataProvider implements GrpcMetadataProvider {
    private static final Metadata.Key<String> HEART_BEAT_HEADER = Metadata.Key.m188of("x-firebase-client-log-type", Metadata.ASCII_STRING_MARSHALLER);
    private static final Metadata.Key<String> USER_AGENT_HEADER = Metadata.Key.m188of("x-firebase-client", Metadata.ASCII_STRING_MARSHALLER);

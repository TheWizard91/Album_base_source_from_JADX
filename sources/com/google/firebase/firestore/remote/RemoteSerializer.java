...
import com.google.firestore.p029v1.ArrayValue;
import com.google.firestore.p029v1.BatchGetDocumentsResponse;
import com.google.firestore.p029v1.Cursor;
import com.google.firestore.p029v1.Document;
import com.google.firestore.p029v1.DocumentChange;
import com.google.firestore.p029v1.DocumentDelete;
import com.google.firestore.p029v1.DocumentMask;
import com.google.firestore.p029v1.DocumentRemove;
import com.google.firestore.p029v1.DocumentTransform;
import com.google.firestore.p029v1.ExistenceFilter;
import com.google.firestore.p029v1.ListenResponse;
import com.google.firestore.p029v1.Precondition;
import com.google.firestore.p029v1.StructuredQuery;
import com.google.firestore.p029v1.Target;
import com.google.firestore.p029v1.TargetChange;
import com.google.firestore.p029v1.Value;
import com.google.firestore.p029v1.Write;
import com.google.firestore.p029v1.WriteResult;
...
public final class RemoteSerializer {
    ...
    public Mutation decodeMutation(Write mutation) {
        ...
        int i = C39161.$SwitchMap$com$google$firestore$v1$Write$OperationCase[mutation.getOperationCase().ordinal()];
        boolean z = true;
        if (i != 1) {
            if (i == 2) {
    ...
    private com.google.firestore.p029v1.Precondition encodePrecondition(Precondition precondition) {
        Assert.hardAssert(!precondition.isNone(), "Can't serialize an empty precondition", new Object[0]);
        Precondition.Builder builder = com.google.firestore.p029v1.Precondition.newBuilder();
        if (precondition.getUpdateTime() != null) {
            return (com.google.firestore.p029v1.Precondition) builder.setUpdateTime(encodeVersion(precondition.getUpdateTime())).build();
        }
        if (precondition.getExists() != null) {
            return (com.google.firestore.p029v1.Precondition) builder.setExists(precondition.getExists().booleanValue()).build();
        }
        throw Assert.fail("Unknown Precondition", new Object[0]);
    }

    private com.google.firebase.firestore.model.mutation.Precondition decodePrecondition(com.google.firestore.p029v1.Precondition precondition) {
        int i = C39161.f1729x8f18ca41[precondition.getConditionTypeCase().ordinal()];
        if (i == 1) {
    ...
    private FieldTransform decodeFieldTransform(DocumentTransform.FieldTransform fieldTransform) {
        int i = C39161.f1727xdd498c9f[fieldTransform.getTransformTypeCase().ordinal()];
        if (i == 1) {
    ...
    private String encodeLabel(QueryPurpose purpose) {
        int i = C39161.$SwitchMap$com$google$firebase$firestore$local$QueryPurpose[purpose.ordinal()];
        if (i == 1) {
            return null;
        }
        if (i == 2) {
    ...
    public com.google.firebase.firestore.core.Target decodeQueryTarget(com.google.firestore.p029v1.Target.QueryTarget r24) {
        /*
            r23 = this;
            r0 = r23
    ...
    private List<Filter> decodeFilters(StructuredQuery.Filter proto) {
        ...
        for (StructuredQuery.Filter filter : filters) {
            int i = C39161.f1731x9d2ee979[filter.getFilterTypeCase().ordinal()];
            if (i == 1) {
    ...
    private Filter decodeUnaryFilter(StructuredQuery.UnaryFilter proto) {
        ...
        int i = C39161.f1732xf473b456[proto.getOp().ordinal()];
        if (i == 1) {
    ...
    private StructuredQuery.FieldFilter.Operator encodeFieldFilterOperator(Filter.Operator operator) {
        switch (C39161.$SwitchMap$com$google$firebase$firestore$core$Filter$Operator[operator.ordinal()]) {
            case 1:
    ...
    private Filter.Operator decodeFieldFilterOperator(StructuredQuery.FieldFilter.Operator operator) {
        switch (C39161.f1730xaf95d2b[operator.ordinal()]) {
            case 1:
    ...
    private OrderBy decodeOrderBy(StructuredQuery.Order proto) {
        ...
        FieldPath fieldPath = FieldPath.fromServerFormat(proto.getField().getFieldPath());
        int i = C39161.$SwitchMap$com$google$firestore$v1$StructuredQuery$Direction[proto.getDirection().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C39161 {
        ...
        static {
            ...
            try {
                f1728x1837d9f[ListenResponse.ResponseTypeCase.DOCUMENT_CHANGE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1728x1837d9f[ListenResponse.ResponseTypeCase.DOCUMENT_DELETE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1728x1837d9f[ListenResponse.ResponseTypeCase.DOCUMENT_REMOVE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f1728x1837d9f[ListenResponse.ResponseTypeCase.FILTER.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f1728x1837d9f[ListenResponse.ResponseTypeCase.RESPONSETYPE_NOT_SET.ordinal()] = 6;
            ...
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.LESS_THAN_OR_EQUAL.ordinal()] = 2;
            } catch (NoSuchFieldError e16) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.EQUAL.ordinal()] = 3;
            } catch (NoSuchFieldError e17) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.GREATER_THAN_OR_EQUAL.ordinal()] = 4;
            } catch (NoSuchFieldError e18) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.GREATER_THAN.ordinal()] = 5;
            } catch (NoSuchFieldError e19) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.ARRAY_CONTAINS.ordinal()] = 6;
            } catch (NoSuchFieldError e20) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.IN.ordinal()] = 7;
            } catch (NoSuchFieldError e21) {
            }
            try {
                f1730xaf95d2b[StructuredQuery.FieldFilter.Operator.ARRAY_CONTAINS_ANY.ordinal()] = 8;
            ...
            f1732xf473b456 = iArr6;
            try {
                iArr6[StructuredQuery.UnaryFilter.Operator.IS_NAN.ordinal()] = 1;
            } catch (NoSuchFieldError e31) {
            }
            try {
                f1732xf473b456[StructuredQuery.UnaryFilter.Operator.IS_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError e32) {
            }
            int[] iArr7 = new int[StructuredQuery.Filter.FilterTypeCase.values().length];
            f1731x9d2ee979 = iArr7;
            try {
                iArr7[StructuredQuery.Filter.FilterTypeCase.COMPOSITE_FILTER.ordinal()] = 1;
            } catch (NoSuchFieldError e33) {
            }
            try {
                f1731x9d2ee979[StructuredQuery.Filter.FilterTypeCase.FIELD_FILTER.ordinal()] = 2;
            } catch (NoSuchFieldError e34) {
            }
            try {
                f1731x9d2ee979[StructuredQuery.Filter.FilterTypeCase.UNARY_FILTER.ordinal()] = 3;
            ...
            f1727xdd498c9f = iArr9;
            try {
                iArr9[DocumentTransform.FieldTransform.TransformTypeCase.SET_TO_SERVER_VALUE.ordinal()] = 1;
            } catch (NoSuchFieldError e39) {
            }
            try {
                f1727xdd498c9f[DocumentTransform.FieldTransform.TransformTypeCase.APPEND_MISSING_ELEMENTS.ordinal()] = 2;
            } catch (NoSuchFieldError e40) {
            }
            try {
                f1727xdd498c9f[DocumentTransform.FieldTransform.TransformTypeCase.REMOVE_ALL_FROM_ARRAY.ordinal()] = 3;
            } catch (NoSuchFieldError e41) {
            }
            try {
                f1727xdd498c9f[DocumentTransform.FieldTransform.TransformTypeCase.INCREMENT.ordinal()] = 4;
            } catch (NoSuchFieldError e42) {
            }
            int[] iArr10 = new int[Precondition.ConditionTypeCase.values().length];
            f1729x8f18ca41 = iArr10;
            try {
                iArr10[Precondition.ConditionTypeCase.UPDATE_TIME.ordinal()] = 1;
            } catch (NoSuchFieldError e43) {
            }
            try {
                f1729x8f18ca41[Precondition.ConditionTypeCase.EXISTS.ordinal()] = 2;
            } catch (NoSuchFieldError e44) {
            }
            try {
                f1729x8f18ca41[Precondition.ConditionTypeCase.CONDITIONTYPE_NOT_SET.ordinal()] = 3;
    ...
    public WatchChange decodeWatchChange(ListenResponse protoChange) {
        ...
        int i = C39161.f1728x1837d9f[protoChange.getResponseTypeCase().ordinal()];
        if (i == 1) {
            TargetChange targetChange = protoChange.getTargetChange();
            Status cause = null;
            int i2 = C39161.$SwitchMap$com$google$firestore$v1$TargetChange$TargetChangeType[targetChange.getTargetChangeType().ordinal()];
            if (i2 == 1) {

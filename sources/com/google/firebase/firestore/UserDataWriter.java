...
public class UserDataWriter {
    ...
    static /* synthetic */ class C38851 {
        ...
        static {
            ...
            try {
                f1703x1f31a5ae[DocumentSnapshot.ServerTimestampBehavior.ESTIMATE.ordinal()] = 2;
    ...
    private Object convertServerTimestamp(Value serverTimestampValue) {
        int i = C38851.f1703x1f31a5ae[this.serverTimestampBehavior.ordinal()];
        if (i == 1) {

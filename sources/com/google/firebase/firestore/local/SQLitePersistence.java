...
public final class SQLitePersistence extends Persistence {
    ...
    /* renamed from: db */
    private SQLiteDatabase f1713db;
    ...
    public void start() {
        ...
        this.started = true;
        try {
            this.f1713db = this.opener.getWritableDatabase();
    ...
    public void runTransaction(String action, Runnable operation) {
        ...
        this.f1713db.beginTransactionWithListener(this.transactionListener);
        try {
            operation.run();
            this.f1713db.setTransactionSuccessful();
        } finally {
            this.f1713db.endTransaction();
        }
    }
    ...
    public void execute(String sql, Object... args) {
        this.f1713db.execSQL(sql, args);
    }

    /* access modifiers changed from: package-private */
    public SQLiteStatement prepare(String sql) {
        return this.f1713db.compileStatement(sql);
    }
    ...
    public Query query(String sql) {
        return new Query(this.f1713db, sql);
    }
    ...
    static class Query {
        ...
        /* renamed from: db */
        private final SQLiteDatabase f1715db;
        ...
        private Cursor startQuery() {
            ...
            if (cursorFactory2 != null) {
                return this.f1715db.rawQueryWithFactory(cursorFactory2, this.sql, (String[]) null, (String) null);
            }
            return this.f1715db.rawQuery(this.sql, (String[]) null);
        }
    }
    ...
    static class LongQuery {
        ...
        /* renamed from: db */
        private final SQLitePersistence f1714db;
        ...
        public Query performNextSubquery() {
            ...
            return this.f1714db.query(this.head + placeholdersBuilder.toString() + this.tail).binding(subqueryArgs.toArray());
        }

...
public final class LocalSerializer {
    ...
    public com.google.firebase.firestore.model.MaybeDocument decodeMaybeDocument(MaybeDocument proto) {
        int i = C38941.f1707xe45654f0[proto.getDocumentTypeCase().ordinal()];
        if (i == 1) {
    ...
    private com.google.firestore.p029v1.Document encodeDocument(Document document) {
        Document.Builder builder = com.google.firestore.p029v1.Document.newBuilder();
        ...
        return (com.google.firestore.p029v1.Document) builder.build();
    }

    private com.google.firebase.firestore.model.Document decodeDocument(com.google.firestore.p029v1.Document document, boolean hasCommittedMutations) {
    ...
    public MutationBatch decodeMutationBatch(WriteBatch batch) {
        ...
        int i2 = batch.getWritesCount();
        List<Mutation> mutations = new ArrayList<>(i2);
        for (int i3 = 0; i3 < i2; i3++) {
            mutations.add(this.rpcSerializer.decodeMutation(batch.getWrites(i3)));
        }
    ...
    public TargetData decodeTargetData(Target targetProto) {
        ...
        int i = C38941.f1708x5167ea64[targetProto.getTargetTypeCase().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C38941 {
        ...
        static {
            ...
            try {
                f1708x5167ea64[Target.TargetTypeCase.QUERY.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            int[] iArr2 = new int[MaybeDocument.DocumentTypeCase.values().length];
            f1707xe45654f0 = iArr2;
            try {
                iArr2[MaybeDocument.DocumentTypeCase.DOCUMENT.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1707xe45654f0[MaybeDocument.DocumentTypeCase.NO_DOCUMENT.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f1707xe45654f0[MaybeDocument.DocumentTypeCase.UNKNOWN_DOCUMENT.ordinal()] = 3;

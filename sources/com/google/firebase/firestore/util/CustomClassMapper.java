    ...
    private static class BeanMapper<T> {
        ...
        private void ensureValidDocumentIdType(String fieldDescription, String operation, Type type) {
            if (type != String.class && type != DocumentReference.class) {
                throw new IllegalArgumentException(fieldDescription + " is annotated with @DocumentId but " + operation + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + type + " instead of String or DocumentReference.");
            }
        }

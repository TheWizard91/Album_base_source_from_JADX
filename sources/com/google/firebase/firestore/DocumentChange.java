...
public class DocumentChange {
    ...
    static /* synthetic */ class C38831 {
        ...
        static final /* synthetic */ int[] f1700x33862af7;
        ...
        static {
            ...
            try {
                f1700x33862af7[DocumentViewChange.Type.METADATA.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1700x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1700x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 4;
    ...
    private static Type getType(DocumentViewChange change) {
        int i = C38831.f1700x33862af7[change.getType().ordinal()];
        if (i == 1) {
            return Type.ADDED;
        }
        if (i == 2 || i == 3) {

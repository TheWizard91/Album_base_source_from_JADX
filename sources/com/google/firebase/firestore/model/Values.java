...
import com.google.firestore.p029v1.ArrayValueOrBuilder;
...
public class Values {
    ...
    public static int typeOrder(Value value) {
        switch (C39011.$SwitchMap$com$google$firestore$v1$Value$ValueTypeCase[value.getValueTypeCase().ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;

...
public class FieldFilter extends Filter {
    ...
    public static FieldFilter create(FieldPath path, Filter.Operator operator2, Value value2) {
        if (path.isKeyField()) {
            ...
            Assert.hardAssert((operator2 == Filter.Operator.ARRAY_CONTAINS || operator2 == Filter.Operator.ARRAY_CONTAINS_ANY) ? false : true, operator2.toString() + "queries don't make sense on document keys", new Object[0]);
    ...
    public boolean matchesComparison(int comp) {
        int i = C38871.$SwitchMap$com$google$firebase$firestore$core$Filter$Operator[this.operator.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
    ...
    public String toString() {
        return this.field.canonicalString() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.operator + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.value;
    }

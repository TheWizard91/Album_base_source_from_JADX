...
public class View {
    ...
    public static class DocumentChanges {
        ...
        /* synthetic */ DocumentChanges(DocumentSet x0, DocumentViewChangeSet x1, ImmutableSortedSet x2, boolean x3, C38921 x4) {
            this(x0, x1, x2, x3);
        }
    ...
    public ViewChange applyOnlineStateChange(OnlineState onlineState) {
        ...
        this.current = false;
        return applyChanges(new DocumentChanges(this.documentSet, new DocumentViewChangeSet(), this.mutatedKeys, false, (C38921) null));
    }
    ...
    static /* synthetic */ class C38921 {
        ...
        static {
            ...
            try {
                f1706x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1706x33862af7[DocumentViewChange.Type.METADATA.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1706x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 4;
    ...
    private static int changeTypeOrder(DocumentViewChange change) {
        int i = C38921.f1706x33862af7[change.getType().ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {

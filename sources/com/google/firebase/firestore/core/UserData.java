...
public class UserData {
    ...
    public static class ParseAccumulator {
        ...
        public ParseContext rootContext() {
            return new ParseContext(this, FieldPath.EMPTY_PATH, false, (C38911) null);
        }
    ...
    public static class ParseContext {
        ...
        /* synthetic */ ParseContext(ParseAccumulator x0, FieldPath x1, boolean x2, C38911 x3) {
            this(x0, x1, x2);
        }
        ...
        public boolean isWrite() {
            int i = C38911.$SwitchMap$com$google$firebase$firestore$core$UserData$Source[this.accumulator.dataSource.ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return true;
            }
            if (i == 4 || i == 5) {

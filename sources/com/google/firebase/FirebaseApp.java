...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        componentArr[0] = Component.m1283of(applicationContext2, Context.class, new Class[0]);
        componentArr[1] = Component.m1283of(this, FirebaseApp.class, new Class[0]);
        componentArr[2] = Component.m1283of(options2, FirebaseOptions.class, new Class[0]);

...
public final class DaggerUniversalComponent implements UniversalComponent {
    ...
    private DaggerUniversalComponent(ApplicationModule applicationModuleParam, InflaterConfigModule inflaterConfigModuleParam) {
        ...
        initialize(applicationModuleParam, inflaterConfigModuleParam);
    }
    ...
    private void initialize(ApplicationModule applicationModuleParam, InflaterConfigModule inflaterConfigModuleParam) {
        ...
        InflaterConfigModule_ProvidesDisplayMetricsFactory create = InflaterConfigModule_ProvidesDisplayMetricsFactory.create(inflaterConfigModuleParam, this.providesApplicationProvider);
        this.providesDisplayMetricsProvider = create;
        this.providesPortraitImageLayoutConfigProvider = InflaterConfigModule_ProvidesPortraitImageLayoutConfigFactory.create(inflaterConfigModuleParam, create);

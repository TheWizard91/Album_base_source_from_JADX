...
public final class DaggerInAppMessageComponent implements InAppMessageComponent {
    ...
    private DaggerInAppMessageComponent(InflaterModule inflaterModuleParam) {
        initialize(inflaterModuleParam);
    }
    ...
    private void initialize(InflaterModule inflaterModuleParam) {
        ...
        InflaterModule_ProvidesBannerMessageFactory create = InflaterModule_ProvidesBannerMessageFactory.create(inflaterModuleParam);

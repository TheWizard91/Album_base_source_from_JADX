...
public final class zzeg extends GmsClient<zzer> implements zzeh {
    ...
    public final String getStartServicePackage() {
        if (this.zzc.zza) {
            zza.mo21045i("Preparing to create service connection to fallback implementation", new Object[0]);
            return this.zzb.getPackageName();
        }
        zza.mo21045i("Preparing to create service connection to gms implementation", new Object[0]);

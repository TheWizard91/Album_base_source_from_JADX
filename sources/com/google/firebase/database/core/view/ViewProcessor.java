...
public class ViewProcessor {
    ...
    public ProcessorResult applyOperation(ViewCache oldViewCache, Operation operation, WriteTreeRef writesCache, Node optCompleteCache) {
        ...
        int i = C38672.f1695xc0d7b136[operation.getType().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C38672 {
        ...
        static {
            ...
            try {
                f1695xc0d7b136[Operation.OperationType.Merge.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f1695xc0d7b136[Operation.OperationType.AckUserWrite.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f1695xc0d7b136[Operation.OperationType.ListenComplete.ordinal()] = 4;

...
public class StringNode extends LeafNode<StringNode> {
    ...
    static /* synthetic */ class C38751 {
        ...
        static {
            ...
            try {
                f1699x2aed15f4[Node.HashVersion.V2.ordinal()] = 2;
    ...
    public String getHashRepresentation(Node.HashVersion version) {
        int i = C38751.f1699x2aed15f4[version.ordinal()];
        if (i == 1) {

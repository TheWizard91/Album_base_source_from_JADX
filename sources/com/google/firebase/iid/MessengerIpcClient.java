...
import com.google.android.gms.internal.p014firebaseiid.zza;
import com.google.android.gms.internal.p014firebaseiid.zze;
import com.google.android.gms.internal.p014firebaseiid.zzf;
    ...
    private class Connection implements ServiceConnection {
        ...
        public final /* synthetic */ void lambda$onServiceConnected$0$MessengerIpcClient$Connection(android.os.IBinder r3) {
            /*
                ...
                r2.handleDisconnect(r0, r3)     // Catch:{ all -> 0x001b }
                monitor-exit(r2)     // Catch:{ all -> 0x001b }
                return
            L_0x000b:
                com.google.firebase.iid.MessengerIpcClient$MessengerWrapper r1 = new com.google.firebase.iid.MessengerIpcClient$MessengerWrapper     // Catch:{ RemoteException -> 0x001d }
                r1.<init>(r3)     // Catch:{ RemoteException -> 0x001d }
                r2.gmsCoreMessenger = r1     // Catch:{ RemoteException -> 0x001d }
                r3 = 2
                r2.state = r3     // Catch:{ all -> 0x001b }
                r2.scheduleSendingRequests()     // Catch:{ all -> 0x001b }
                monitor-exit(r2)     // Catch:{ all -> 0x001b }
                return
            L_0x001b:
                r3 = move-exception

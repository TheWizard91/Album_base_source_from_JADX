...
public abstract class NetworkRequest {
    ...
    public void performRequestStart(String token) {
        ...
        if (Log.isLoggable(TAG, 3)) {
            Log.d(TAG, "sending network request " + getAction() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + getURL());
        }
        ...
        try {
            ...
            Log.w(TAG, "error sending network request " + getAction() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + getURL(), e);
            this.mException = e;
            this.resultCode = -2;
        }
    }

...
public class PreJava9DateFormatProvider {
    ...
    public static DateFormat getUSDateTimeFormat(int dateStyle, int timeStyle) {
        return new SimpleDateFormat(getDatePartOfDateTimePattern(dateStyle) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + getTimePartOfDateTimePattern(timeStyle), Locale.US);
    }

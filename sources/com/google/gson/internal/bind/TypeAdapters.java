...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r3, com.google.gson.reflect.TypeToken<T> r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C124030.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    int i2 = C124736.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()];
                    boolean set = false;
                    if (i2 != 1) {
                        if (i2 == 2) {
                            set = in.nextBoolean();
        ...
        C12393 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader in) throws IOException {
        ...
        C12495 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C12506 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C12517 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C122114 r05 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                JsonToken jsonToken = in.peek();
                int i = C124736.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i == 1 || i == 3) {
        ...
        C122215 r06 = new TypeAdapter<Character>() {
        ...
        C122316 r07 = new TypeAdapter<String>() {
        ...
        C122619 r08 = new TypeAdapter<StringBuilder>() {
        ...
        C122820 r09 = new TypeAdapter<StringBuffer>() {
        ...
        C122921 r010 = new TypeAdapter<URL>() {
        ...
        C123022 r011 = new TypeAdapter<URI>() {
        ...
        C123123 r012 = new TypeAdapter<InetAddress>() {
        ...
        C123224 r013 = new TypeAdapter<UUID>() {
        ...
        C123627 r014 = new TypeAdapter<Calendar>() {
        ...
        C123728 r015 = new TypeAdapter<Locale>() {
        ...
        C123829 r016 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                switch (C124736.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C124736 {

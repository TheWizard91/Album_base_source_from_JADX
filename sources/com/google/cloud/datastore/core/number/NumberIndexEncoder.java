    ...
    public static byte[] encode(NumberParts parts) {
        ...
        if (!parts.isInfinite()) {
            ...
            if (exponent < 4) {
                ...
                if (exponent2 <= 15) {
                    buffer[0] = (byte) ((224 | exponent2) ^ ((exponentMask & WorkQueueKt.MASK) ^ inverter));
                ...
                if (exponent3 <= 127) {
                    int bufferPos = 0 + 1;
                    buffer[0] = (byte) ((240 | (exponent3 >>> 4)) ^ ((exponentMask & WorkQueueKt.MASK) ^ inverter));
                    long significand3 = significand2 << 4;
                    buffer[bufferPos] = (byte) ((((exponent3 << 4) & 240) | ((int) (significand2 >>> 60))) ^ ((exponentMask & 240) ^ inverter));
                ...
                if (exponent4 <= 1023) {
                    int bufferPos2 = 0 + 1;
                    buffer[0] = (byte) ((248 | (exponent4 >>> 8)) ^ ((exponentMask & WorkQueueKt.MASK) ^ inverter));

...
public final class C2987a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f1272a;

    /* renamed from: b */
    private static final Map<Integer, String> f1273b;
    ...
    public static String m613a(int i) {
        Map<Integer, String> map = f1272a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f1273b;

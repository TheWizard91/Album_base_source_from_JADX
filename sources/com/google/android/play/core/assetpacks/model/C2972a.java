...
public final class C2972a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f1250a;

    /* renamed from: b */
    private static final Map<Integer, String> f1251b;
    ...
    /* renamed from: a */
    public static String m585a(int i) {
        Map<Integer, String> map = f1250a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f1251b.get(valueOf);

...
public final class C3138a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f1465a;

    /* renamed from: b */
    private static final Map<Integer, String> f1466b;
    ...
    /* renamed from: a */
    public static String m1016a(int i) {
        Map<Integer, String> map = f1465a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        Map<Integer, String> map2 = f1466b;

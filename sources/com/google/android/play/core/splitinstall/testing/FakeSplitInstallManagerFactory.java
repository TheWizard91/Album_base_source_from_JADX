...
public class FakeSplitInstallManagerFactory {
    ...
    /* renamed from: a */
    private static FakeSplitInstallManager f1487a = null;
    ...
    public static synchronized FakeSplitInstallManager create(Context context, File file) {
        ...
        synchronized (FakeSplitInstallManagerFactory.class) {
            FakeSplitInstallManager fakeSplitInstallManager2 = f1487a;
            if (fakeSplitInstallManager2 == null) {
                try {
                    f1487a = new FakeSplitInstallManager(context, file);
                } catch (Exception e) {
                    throw new RuntimeException(e);
                }
            } else if (!fakeSplitInstallManager2.mo44299a().getAbsolutePath().equals(file.getAbsolutePath())) {
                throw new RuntimeException(String.format("Different module directories used to initialize FakeSplitInstallManager: '%s' and '%s'", new Object[]{f1487a.mo44299a().getAbsolutePath(), file.getAbsolutePath()}));
            }
            fakeSplitInstallManager = f1487a;
        }

...
public final class C3091m {
    ...
    /* renamed from: b */
    private static final Pattern f1379b = Pattern.compile("lib/([^/]+)/(.*\\.so)$");

    /* renamed from: c */
    private final C3083e f1380c;

    C3091m(C3083e eVar) throws IOException {
        this.f1380c = eVar;
    }

    /* renamed from: a */
    static /* synthetic */ Set m927a(C3091m mVar, Set set, C3096r rVar, ZipFile zipFile) throws IOException {
        HashSet hashSet = new HashSet();
        mVar.m930a(rVar, set, new C3087i(hashSet, rVar, zipFile));
        return hashSet;
    }
    ...
    private static void m929a(com.google.android.play.core.splitcompat.C3096r r13, com.google.android.play.core.splitcompat.C3088j r14) throws java.io.IOException {
        /*
            java.util.zip.ZipFile r0 = new java.util.zip.ZipFile     // Catch:{ IOException -> 0x00f0 }
            java.io.File r1 = r13.mo44213a()     // Catch:{ IOException -> 0x00f0 }
            r0.<init>(r1)     // Catch:{ IOException -> 0x00f0 }
            java.lang.String r13 = r13.mo44214b()     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x0016:
            ...
            java.util.regex.Pattern r9 = f1379b     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x0073:
            ...
            r14.mo44234a(r0, r1)     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x00a4:
            ...
            com.google.android.play.core.splitcompat.l r11 = (com.google.android.play.core.splitcompat.C3090l) r11     // Catch:{ IOException -> 0x00ee }
            java.lang.String r12 = r11.f1376a     // Catch:{ IOException -> 0x00ee }
            ...
            java.lang.String r11 = r11.f1376a     // Catch:{ IOException -> 0x00ee }
        ...
        L_0x00f8:
            r14 = move-exception
            com.google.android.play.core.internal.C3046cd.m768a(r13, r14)
        L_0x00fc:
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.splitcompat.C3091m.m929a(com.google.android.play.core.splitcompat.r, com.google.android.play.core.splitcompat.j):void");
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m930a(C3096r rVar, Set<C3090l> set, C3089k kVar) throws IOException {
        for (C3090l next : set) {
            File a = this.f1380c.mo44221a(rVar.mo44214b(), next.f1376a);
            boolean z = false;
            if (a.exists() && a.length() == next.f1377b.getSize()) {
                z = true;
            }
            kVar.mo44233a(next, a, z);
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final Set<File> mo44235a() throws IOException {
        Log.d("SplitCompat", "NativeLibraryExtractor: synchronizing native libraries");
        Set<C3096r> d = this.f1380c.mo44228d();
        for (String next : this.f1380c.mo44230e()) {
            Iterator<C3096r> it = d.iterator();
            while (true) {
                if (it.hasNext()) {
                    if (it.next().mo44214b().equals(next)) {
                        break;
                    }
                } else {
        ...
        for (C3096r next2 : d) {
            ...
            m929a(next2, new C3086h(this, hashSet2, next2));
            for (File next3 : this.f1380c.mo44231e(next2.mo44214b())) {
                if (!hashSet2.contains(next3)) {
                    Log.i("SplitCompat", String.format("NativeLibraryExtractor: file '%s' found in split '%s' that is not in the split file '%s'; removing", new Object[]{next3.getAbsolutePath(), next2.mo44214b(), next2.mo44213a().getAbsolutePath()}));
                    this.f1380c.mo44225b(next3);
                }
            }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final Set<File> mo44236a(C3096r rVar) throws IOException {
        AtomicBoolean atomicBoolean = new AtomicBoolean(true);
        HashSet hashSet = new HashSet();
        m929a(rVar, new C3085g(this, rVar, hashSet, atomicBoolean));

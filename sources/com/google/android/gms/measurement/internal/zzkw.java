                    ...
                    if (i3 != 0 && !"_ev".equals(str4)) {
                        ...
                        if (i6 > i) {
                            if (zza2) {
                                ...
                                str5 = new StringBuilder(63).append("Child bundles can't contain more than ").append(i).append(" custom params").toString();
                            }
    ...
    public final void zza(zzfd zzfd, int i) {
        ...
        for (String str : new TreeSet(zzfd.zzb.keySet())) {
            if (zza(str) && (i2 = i2 + 1) > i) {
                zzr().zzh().zza(new StringBuilder(48).append("Event can't contain more than ").append(i).append(" params").toString(), zzo().zza(zzfd.zza), zzo().zza(zzfd.zzb));
                zzb(zzfd.zzb, 5);
                zzfd.zzb.remove(str);
            }
        }

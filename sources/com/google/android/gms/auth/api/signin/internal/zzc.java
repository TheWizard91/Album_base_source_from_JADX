    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zzcb.mo21042e("Unable to revoke access!", new Object[0]);
            }
            zzcb.mo21040d(new StringBuilder(26).append("Response Code: ").append(responseCode).toString(), new Object[0]);
        } catch (IOException e) {
            Logger logger = zzcb;
            String valueOf3 = String.valueOf(e.toString());
            logger.mo21042e(valueOf3.length() != 0 ? "IOException when revoking access: ".concat(valueOf3) : new String("IOException when revoking access: "), new Object[0]);
        } catch (Exception e2) {
            Logger logger2 = zzcb;
            String valueOf4 = String.valueOf(e2.toString());
            logger2.mo21042e(valueOf4.length() != 0 ? "Exception when revoking access: ".concat(valueOf4) : new String("Exception when revoking access: "), new Object[0]);
        }

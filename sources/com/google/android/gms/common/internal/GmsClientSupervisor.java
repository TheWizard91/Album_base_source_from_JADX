    ...
    protected static final class zza {
        ...
        private final android.content.Intent zzc(android.content.Context r6) {
            /*
                ...
                r1.putString(r3, r2)
                r2 = 0
                android.content.ContentResolver r6 = r6.getContentResolver()     // Catch:{ IllegalArgumentException -> 0x001e }
                android.net.Uri r3 = zzee     // Catch:{ IllegalArgumentException -> 0x001e }
                java.lang.String r4 = "serviceIntentCall"
                android.os.Bundle r6 = r6.call(r3, r4, r2, r1)     // Catch:{ IllegalArgumentException -> 0x001e }
                goto L_0x0044
            L_0x001e:
                r6 = move-exception
        ...
        public final boolean equals(Object obj) {
            ...
            zza zza = (zza) obj;
            if (!Objects.equal(this.zzeb, zza.zzeb) || !Objects.equal(this.packageName, zza.packageName) || !Objects.equal(this.componentName, zza.componentName) || this.zzec != zza.zzec || this.zzed != zza.zzed) {
                return false;
            }
            return true;
        }

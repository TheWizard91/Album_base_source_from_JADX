...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    public String toString() {
        return new StringBuilder(24).append("ActivityType ").append(this.zzi).toString() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + new StringBuilder(26).append("TransitionType ").append(this.zzj).toString() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + new StringBuilder(41).append("ElapsedRealTimeNanos ").append(this.zzk).toString();
    }

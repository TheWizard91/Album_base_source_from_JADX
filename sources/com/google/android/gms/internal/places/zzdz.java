...
final class zzdz {
    ...
    public static void zzb(byte b, byte b2, char[] cArr, int i) throws zzbk {
        ...
        cArr[i] = (char) (((b & Ascii.f1616US) << 6) | (b2 & 63));
    }
    ...
    public static void zzb(byte b, byte b2, byte b3, char[] cArr, int i) throws zzbk {
        ...
        cArr[i] = (char) (((b & Ascii.f1613SI) << Ascii.f1606FF) | ((b2 & 63) << 6) | (b3 & 63));
    }

    /* access modifiers changed from: private */
    public static void zzb(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzbk {
        if (zzh(b2) || (((b << Ascii.f1607FS) + (b2 + 112)) >> 30) != 0 || zzh(b3) || zzh(b4)) {
            throw zzbk.zzbu();
        }
        byte b5 = ((b & 7) << Ascii.DC2) | ((b2 & 63) << Ascii.f1606FF) | ((b3 & 63) << 6) | (b4 & 63);

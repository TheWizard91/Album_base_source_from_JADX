...
public final class zzp {
    ...
    /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
    public static final class zza extends zzig<zza, C4075zza> implements zzjt {
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class C4075zza extends zzig.zzb<zza, C4075zza> implements zzjt {
            private C4075zza() {
                super(zza.zzs);
            }

            public final C4075zza zza(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public final C4075zza zzb(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
            ...
            public final C4075zza zzc(String str) {
                if (this.zzb) {
                    zzb();
                    this.zzb = false;
                }
        ...
        public static C4075zza zza() {
            return (C4075zza) zzs.zzz();
        }
    ...
    public static final class zzl extends zzig<zzl, zzb> implements zzjt {
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig<zza, C4076zza> implements zzjt {
            /* access modifiers changed from: private */
            ...
            /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
            public static final class C4076zza extends zzig.zzb<zza, C4076zza> implements zzjt {
                private C4076zza() {
                    super(zza.zze);
                }

                public final C4076zza zza(String str) {
                    if (this.zzb) {
                        zzb();
                        this.zzb = false;
                    }
            ...
            public static C4076zza zza() {
                return (C4076zza) zze.zzz();
            }
    ...
    public static final class zzn extends zzig<zzn, zzb> implements zzjt {
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig<zza, C4077zza> implements zzjt {
            /* access modifiers changed from: private */
            ...
            /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
            public static final class C4077zza extends zzig.zzb<zza, C4077zza> implements zzjt {
                private C4077zza() {
                    super(zza.zzd);
                }

                /* synthetic */ C4077zza(zzo zzo) {
                    this();
                }
            }
    ...
    /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
    public static final class C4078zzp extends zzig<C4078zzp, zza> implements zzjt {
        /* access modifiers changed from: private */
        public static final C4078zzp zzo;
        private static volatile zzkb<C4078zzp> zzp;
        private int zzc;
        private String zzd = "";
        private String zze = "";
        private String zzf = "";
        ...
        /* compiled from: com.google.firebase:firebase-auth@@19.3.2 */
        public static final class zza extends zzig.zzb<C4078zzp, zza> implements zzjt {
            private zza() {
                super(C4078zzp.zzo);
            }
        ...
        public final Object zza(int i, Object obj, Object obj2) {
            switch (zzo.zza[i - 1]) {
                ...
                case 4:
                    return zzo;
                case 5:
                    zzkb<C4078zzp> zzkb = zzp;
                    if (zzkb == null) {
                        synchronized (C4078zzp.class) {
                            zzkb = zzp;
                            if (zzkb == null) {
        ...
        static {
            C4078zzp zzp2 = new C4078zzp();
            zzo = zzp2;
            zzig.zza(C4078zzp.class, zzp2);
        }
    }

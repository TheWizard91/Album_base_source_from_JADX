...
final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public String toString() {
        return "PersistedEvent{id=" + this.f104id + ", transportContext=" + this.transportContext + ", event=" + this.event + "}";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.f104id != that.getId() || !this.transportContext.equals(that.getTransportContext()) || !this.event.equals(that.getEvent())) {
            return false;
        }
        return true;
    }

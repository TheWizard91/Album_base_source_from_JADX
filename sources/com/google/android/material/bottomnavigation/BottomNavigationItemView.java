...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C2413R.C2418layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2413R.C2415drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C2413R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2413R.C2416id.icon);
        TextView textView = (TextView) findViewById(C2413R.C2416id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C2413R.C2416id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        infoCompat.setRoleDescription(getResources().getString(C2413R.string.item_view_role_description));
    }

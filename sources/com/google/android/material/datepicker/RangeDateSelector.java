...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(display.widthPixels, display.heightPixels) > res.getDimensionPixelSize(C2413R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis) ? C2413R.attr.materialCalendarTheme : C2413R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return res.getString(C2413R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return res.getString(C2413R.string.mtrl_picker_range_header_only_start_selected, new Object[]{DateStrings.getDateString(this.selectedStartItem.longValue())});
        } else if (l == null) {
            return res.getString(C2413R.string.mtrl_picker_range_header_only_end_selected, new Object[]{DateStrings.getDateString(this.selectedEndItem.longValue())});
        } else {
            Pair<String, String> dateRangeStrings = DateStrings.getDateRangeString(l, l2);
            return res.getString(C2413R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeStrings.first, dateRangeStrings.second});
        }
    }

    public int getDefaultTitleResId() {
        return C2413R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Pair<Long, Long>> listener) {
        View root = layoutInflater.inflate(C2413R.C2418layout.mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout startTextInput = (TextInputLayout) root.findViewById(C2413R.C2416id.mtrl_picker_text_input_range_start);
        TextInputLayout endTextInput = (TextInputLayout) root.findViewById(C2413R.C2416id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = root.getResources().getString(C2413R.string.mtrl_picker_invalid_range);
        ...
        C26981 r0 = new DateFormatTextWatcher(textInputHint, format, startTextInput, calendarConstraints) {
    ...
    private void clearInvalidRange(TextInputLayout start, TextInputLayout end) {
        ...
        if (end.getError() != null && MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR.contentEquals(end.getError())) {
    ...
    private void setInvalidRange(TextInputLayout start, TextInputLayout end) {
        ...
        end.setError(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
    }

...
class UtcDates {
    ...
    static String getTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        return formatHint.replaceAll("d", res.getString(C2413R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", res.getString(C2413R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", res.getString(C2413R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static String removeYearFromDateFormatPattern(String pattern) {
        ...
        return pattern.replace(pattern.substring(findCharactersInDateFormatPattern(pattern, monthDayCharacters, -1, yearPosition) + 1, yearEndPosition), MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).trim();
    }

...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, C2413R.attr.editTextStyle);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C2413R.styleable.TextInputEditText, defStyleAttr, C2413R.C2419style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(attributes.getBoolean(C2413R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
        attributes.recycle();
    }
    ...
    public boolean requestRectangleOnScreen(Rect rectangle) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(C2413R.dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout layout) {
        ...
        String hint2 = (hint + (((showingError || hasHelperText) && !TextUtils.isEmpty(hint)) ? ", " : str)) + (showingError ? errorText : hasHelperText ? helperText : str);
        if (showingText) {

...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C2413R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C2413R.attr.snackbarButtonStyle, C2413R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarContentStyleAttrs(parent.getContext()) ? C2413R.C2418layout.mtrl_layout_snackbar_include : C2413R.C2418layout.design_layout_snackbar_include, parent, false);

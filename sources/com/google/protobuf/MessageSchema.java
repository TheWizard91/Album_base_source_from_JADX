...
final class MessageSchema<T> implements Schema<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r11v37, resolved type: java.lang.reflect.Field} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v22, resolved type: java.lang.String} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v25, resolved type: java.lang.reflect.Field} */
    ...
    static <T> com.google.protobuf.MessageSchema<T> newSchemaForRawMessageInfo(com.google.protobuf.RawMessageInfo r43, com.google.protobuf.NewInstanceSchema r44, com.google.protobuf.ListFieldSchema r45, com.google.protobuf.UnknownFieldSchema<?, ?> r46, com.google.protobuf.ExtensionSchema<?> r47, com.google.protobuf.MapFieldSchema r48) {
        ...
        L_0x02b2:
            ...
            int r1 = r1 + 1
            r3 = r30[r1]
            boolean r11 = r3 instanceof java.lang.reflect.Field
        ...
        L_0x02d0:
            r40 = r3
            r31 = r4
            long r3 = r15.objectFieldOffset(r11)
            int r3 = (int) r3
            r1 = 0
            r40 = r0
            r41 = r2
        ...
        L_0x0373:
            ...
            int r6 = (int) r6
            r7 = r20 & 1
            if (r7 != r11) goto L_0x03da
            r7 = 17
            if (r9 > r7) goto L_0x03da
            int r7 = r8 + 1
            char r4 = r0.charAt(r8)
            r8 = 55296(0xd800, float:7.7486E-41)
            if (r4 < r8) goto L_0x03ae
            r8 = r4 & 8191(0x1fff, float:1.1478E-41)
            r18 = 13
        L_0x0390:
            int r19 = r7 + 1
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        for (FieldInfo fi : fis) {
            if (fi.getType() == FieldType.MAP) {
                mapFieldCount++;
            } else if (fi.getType().mo25143id() >= 18 && fi.getType().mo25143id() <= 49) {
                repeatedFieldCount++;
            }
        }
        ...
        while (checkInitializedIndex2 < fis.length) {
            ...
            } else if (fi2.getType().mo25143id() < 18 || fi2.getType().mo25143id() > 49) {
                fieldIndex = checkInitializedIndex2;
            } else {
                fieldIndex = checkInitializedIndex2;
    ...
    private static void storeFieldData(FieldInfo fi, int[] buffer2, int bufferIndex, boolean proto32, Object[] objects2) {
        ...
        if (oneof != null) {
            typeId2 = fi.getType().mo25143id() + 51;
            ...
            int typeId3 = type.mo25143id();
            if (!proto32 && !type.isList() && !type.isMap()) {
                typeId2 = typeId3;
                typeId = (int) UnsafeUtil.objectFieldOffset(fi.getPresenceField());
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            } else if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.mo25143id() && fieldType <= FieldType.SINT64_LIST_PACKED.mo25143id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            int cachedSizeOffset = (fieldType < FieldType.DOUBLE_LIST_PACKED.mo25143id() || fieldType > FieldType.SINT64_LIST_PACKED.mo25143id()) ? 0 : this.buffer[i + 2] & OFFSET_MASK;
            switch (fieldType) {
                case 0:
    ...
    private int decodeMapEntryValue(byte[] data, int position, int limit, WireFormat.FieldType fieldType, Class<?> messageType, ArrayDecoders.Registers registers) throws IOException {
        switch (C13201.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:

...
final class ArrayDecoders {
    ...
    static int decodeVarint32(int firstByte, byte[] data, int position, Registers registers) {
        ...
        if (position3 >= 0) {
            registers.int1 = (position3 << 7) | value;
            return position2;
        }
        int value2 = value | ((position3 & Byte.MAX_VALUE) << 7);
        int position4 = position2 + 1;
        byte b3 = data[position2];
        if (b3 >= 0) {
            registers.int1 = (b3 << Ascii.f1614SO) | value2;
            return position4;
        }
        int value3 = value2 | ((b3 & Byte.MAX_VALUE) << Ascii.f1614SO);
        int position5 = position4 + 1;
        byte b4 = data[position4];
        if (b4 >= 0) {
        ...
        byte b5 = data[position5];
        if (b5 >= 0) {
            registers.int1 = (b5 << Ascii.f1607FS) | value4;
            return position6;
        }
        int value5 = value4 | ((b5 & Byte.MAX_VALUE) << Ascii.f1607FS);
        while (true) {
    ...
    static int decodeExtension(int tag, byte[] data, int position, int limit, GeneratedMessageLite.ExtendableMessage<?, ?> message, GeneratedMessageLite.GeneratedExtension<?, ?> extension, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (!generatedExtension.descriptor.isRepeated() || !generatedExtension.descriptor.isPacked()) {
            ...
            if (extension.getLiteType() != WireFormat.FieldType.ENUM) {
                switch (C12781.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()]) {
                    case 1:
                        int i2 = limit;
            ...
            if (extension.isRepeated()) {
                ...
                int i17 = C12781.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()];

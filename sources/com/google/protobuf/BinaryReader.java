...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(C12791 x0) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private Object readField(WireFormat.FieldType fieldType, Class<?> messageType, ExtensionRegistryLite extensionRegistry) throws IOException {
            switch (C12791.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
                case 1:
            ...
            if (i3 != this.pos) {
                ...
                if (i5 >= 0) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = y + 1;
                        int i8 = (bArr[y] << Ascii.f1614SO) ^ x2;
                        int x3 = i8;
                        if (i8 >= 0) {
                            int i9 = i7;
                            i = x3 ^ 16256;
                            ...
                            if (i10 < 0) {
                                ...
                                int i11 = y + 1;
                                byte y2 = bArr[y];
                                int x5 = (x4 ^ (y2 << Ascii.f1607FS)) ^ 266354560;
                                if (y2 < 0) {
                                    int i12 = i11 + 1;
                                    if (bArr[i11] < 0) {
                                        i11 = i12 + 1;
            ...
            if (i2 != i) {
                ...
                if (i4 >= 0) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = i5 + 1;
                        int i8 = (buffer2[i5] << Ascii.f1614SO) ^ y2;
                        int y3 = i8;
                        if (i8 >= 0) {
                            x = (long) (y3 ^ 16256);
                            i5 = i7;

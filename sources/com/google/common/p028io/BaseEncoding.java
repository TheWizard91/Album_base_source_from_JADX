            ...
            if (this.alphabet.isValidPaddingStartPosition(chars2.length())) {
                ...
                while (i < chars2.length()) {
                    ...
                    if (i3 < chars2.length()) {
                        ...
                        if (i4 < chars2.length()) {
                            target[chunk4] = (byte) ((chunk3 | this.alphabet.decode(chars2.charAt(i4))) & 255);
                            chunk = chunk4 + 1;
                            i = i4 + 1;
                        } else {
                            chunk = chunk4;
        ...
        return new Reader() {
            ...
            public int read() throws java.io.IOException {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p028io.BaseEncoding.C35953.read():int");
            }

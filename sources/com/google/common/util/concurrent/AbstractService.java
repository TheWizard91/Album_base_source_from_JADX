...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C36776.$SwitchMap$com$google$common$util$concurrent$Service$State[previous.ordinal()]) {
                    case 1:
    ...
    public final void notifyFailed(Throwable cause) {
        ...
        try {
            Service.State previous = state();
            int i = C36776.$SwitchMap$com$google$common$util$concurrent$Service$State[previous.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
    ...
    private void enqueueTerminatedEvent(Service.State from) {
        switch (C36776.$SwitchMap$com$google$common$util$concurrent$Service$State[from.ordinal()]) {
            case 1:

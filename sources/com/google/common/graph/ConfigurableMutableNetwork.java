...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N nodeU, N nodeV, E edge) {
        ...
        if (containsEdge(edge)) {
            ...
            EndpointPair<N> newIncidentNodes = EndpointPair.m1237of((Network<?, ?>) this, nodeU, nodeV);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m1234of();
            }
            return DirectedNetworkConnections.m1235of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m1240of();
        } else {
            return UndirectedNetworkConnections.m1241of();
        }
    }
}

...
import com.google.common.p028io.ByteSource;
import com.google.common.p028io.CharSource;
import com.google.common.p028io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m1122on(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m1274of(String resourceName2, ClassLoader loader2) {
    ...
    static abstract class Scanner {
        ...
        private static ImmutableList<URL> getClassLoaderUrls(ClassLoader classloader) {
            ...
            return ImmutableList.m1137of();
        }

        static ImmutableList<URL> parseJavaClassPath() {
            ImmutableList.Builder<URL> urls = ImmutableList.builder();
            for (String entry : Splitter.m1122on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
                    urls.add((Object) new File(entry).toURI().toURL());
                } catch (SecurityException e) {
                    try {
                        urls.add((Object) new URL(UriUtil.LOCAL_FILE_SCHEME, (String) null, new File(entry).getAbsolutePath()));
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry<ClassLoader, String> entry : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m1274of(entry.getValue(), entry.getKey()));
            }
            return builder.build();
        }

...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m1107on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            return builder.append(this.rawType.getName()).append(Typography.less).append(Types.COMMA_JOINER.join((Iterable<?>) Iterables.transform(this.argumentsList, Types.TYPE_NAME))).append(Typography.greater).toString();
        }

...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: at */
    public V mo46803at(int rowIndex, int columnIndex) {
    ...
    public V get(@NullableDecl Object rowKey, @NullableDecl Object columnKey) {
        ...
        return mo46803at(rowIndex.intValue(), columnIndex.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(int index) {
        return new Tables.AbstractCell<R, C, V>(index) {
            ...
            public V getValue() {
                return ArrayTable.this.mo46803at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int index) {
        return mo46803at(index / this.columnList.size(), index % this.columnList.size());
    }

    public Map<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        Integer columnIndex = this.columnKeyToIndex.get(columnKey);
        return columnIndex == null ? ImmutableMap.m1156of() : new Column(columnIndex.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int index) {
            return ArrayTable.this.mo46803at(index, this.columnIndex);
        }
    ...
    public Map<C, V> row(R rowKey) {
        Preconditions.checkNotNull(rowKey);
        Integer rowIndex = this.rowKeyToIndex.get(rowKey);
        return rowIndex == null ? ImmutableMap.m1156of() : new Row(rowIndex.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int index) {
            return ArrayTable.this.mo46803at(this.rowIndex, index);
        }

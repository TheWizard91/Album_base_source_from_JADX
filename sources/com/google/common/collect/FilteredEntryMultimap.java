    ...
    class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public Set<K> createKeySet() {
            return new Maps.KeySet<K, Collection<V>>() {
                public boolean removeAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.m1112in(c)));
                }

                public boolean retainAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m1112in(c))));
                }
        ...
        public Set<Map.Entry<K, Collection<V>>> createEntrySet() {
            return new Maps.EntrySet<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.m1112in(c));
                }

                public boolean retainAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Predicates.not(Predicates.m1112in(c)));
                }
        ...
        public Collection<Collection<V>> createValues() {
            return new Maps.Values<K, Collection<V>>() {
                ...
                public boolean removeAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.m1112in(c)));
                }

                public boolean retainAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeEntriesIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m1112in(c))));
                }
            };
        }
    }
    ...
    class Keys extends Multimaps.Keys<K, V> {
        ...
        public Set<Multiset.Entry<K>> entrySet() {
            return new Multisets.EntrySet<K>() {
                ...
                public boolean removeAll(Collection<?> c) {
                    return removeEntriesIf(Predicates.m1112in(c));
                }

                public boolean retainAll(Collection<?> c) {
                    return removeEntriesIf(Predicates.not(Predicates.m1112in(c)));
                }
            };
        }
    }

...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m1138of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m1137of());
    @LazyInit
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m1177of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m1178of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m1138of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.isEmpty()) {
            ...
            ImmutableRangeSet<C> of = m1177of();
            this.complement = of;
            return of;
        }
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> domain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m1217of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (mergedRanges.isEmpty()) {
                return ImmutableRangeSet.m1177of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m1138of(Range.all()))) {
                return ImmutableRangeSet.all();
            }

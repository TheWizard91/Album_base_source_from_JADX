...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo45879or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m1127of() {
        return from(ImmutableList.m1137of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m1128of(@NullableDecl E element, E... elements) {
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m1108of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (iterable instanceof List) {
            ...
            return Optional.m1108of(list.get(list.size() - 1));
        }
        ...
        if (iterable instanceof SortedSet) {
            return Optional.m1108of(((SortedSet) iterable).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m1108of(current);
    }

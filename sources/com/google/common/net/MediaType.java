...
public final class MediaType {
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m1107on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m1151of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String type2, String subtype2) {
        MediaType mediaType = addKnownType(new MediaType(type2, subtype2, ImmutableListMultimap.m1150of()));
    ...
    private static MediaType createConstantUtf8(String type2, String subtype2) {
        ...
        mediaType.parsedCharset = Optional.m1108of(Charsets.UTF_8);
        return mediaType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (local == null) {
            ...
            while (it.hasNext()) {
                ...
                if (value == null) {
                    value = currentValue;
                    local = Optional.m1108of(Charset.forName(value));
    ...
    public MediaType withParameter(String attribute, String value) {
        return withParameters(attribute, ImmutableSet.m1180of(value));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withCharset = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withCharset.parsedCharset = Optional.m1108of(charset);
        return withCharset;
    }
    ...
    /* renamed from: is */
    public boolean mo49542is(MediaType mediaTypeRange) {
    ...
    public static MediaType create(String type2, String subtype2) {
        MediaType mediaType = create(type2, subtype2, ImmutableListMultimap.m1150of());
        mediaType.parsedCharset = Optional.absent();
        return mediaType;
    }

...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m1106on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m1119on('.');
    ...
    static {
        ...
        DASH_MATCHER = anyOf;
        PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo45913or(anyOf);
    }
    ...
    InternetDomainName(String name2) {
        ...
        this.parts = copyOf;
        Preconditions.checkArgument(copyOf.size() > 127 ? false : z, "Domain has too many parts: '%s'", (Object) name3);
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m1108of(PublicSuffixType.REGISTRY));
    }

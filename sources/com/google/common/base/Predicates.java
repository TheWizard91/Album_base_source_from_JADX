...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m1114or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m1115or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy((T[]) components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m1113or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m1112in(Collection<? extends T> target) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f1620f;

        /* renamed from: p */
        final Predicate<B> f1621p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f1621p = (Predicate) Preconditions.checkNotNull(p);
            this.f1620f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f1621p.apply(this.f1620f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f1620f.equals(that.f1620f) || !this.f1621p.equals(that.f1621p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f1620f.hashCode() ^ this.f1621p.hashCode();
        }

        public String toString() {
            return this.f1621p + "(" + this.f1620f + ")";
        }
    }

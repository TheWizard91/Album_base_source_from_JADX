...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f1618f;

        /* renamed from: g */
        private final Function<B, C> f1619g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f1619g = (Function) Preconditions.checkNotNull(g);
            this.f1618f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@NullableDecl A a) {
            return this.f1619g.apply(this.f1618f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f1618f.equals(that.f1618f) || !this.f1619g.equals(that.f1619g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f1618f.hashCode() ^ this.f1619g.hashCode();
        }

        public String toString() {
            return this.f1619g + "(" + this.f1618f + ")";
        }
    }

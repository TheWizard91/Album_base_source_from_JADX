...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m1100is(char match) {
        return new C3241Is(match);
    }
    ...
    public static CharMatcher anyOf(CharSequence sequence) {
        ...
        if (length == 1) {
            return m1100is(sequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo45913or(CharMatcher other) {
        return new C3242Or(this, other);
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        ...
        if (totalCharacters == 1) {
            return m1100is((char) table.nextSetBit(0));
        }
    ...
    private static final class C3242Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C3242Or(CharMatcher a, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C3241Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo45913or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo45913or(other);
        }

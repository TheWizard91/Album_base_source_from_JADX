...
public final class AnnotatedClass extends Annotated {
    ...
    private void resolveMemberMethods() {
        ...
        for (Class next : this._superTypes) {
            ...
            _addMemberMethods(next, this._memberMethods, mixInResolver == null ? null : mixInResolver.findMixInClassFor(next), annotatedMethodMap);
        }
    ...
    public AnnotatedConstructor _constructConstructor(Constructor<?> constructor, boolean z) {
        ...
        if (length != parameterAnnotations.length) {
            ...
            if (declaringClass.isEnum() && length == parameterAnnotations.length + 2) {
                ...
                Annotation[][] annotationArr3 = new Annotation[(parameterAnnotations.length + 1)][];
                System.arraycopy(parameterAnnotations, 0, annotationArr3, 1, parameterAnnotations.length);
                Annotation[][] annotationArr4 = annotationArr3;
                annotationMapArr = _collectRelevantAnnotations(annotationArr3);

...
public final class BaseSettings implements Serializable {
    ...
    public BaseSettings with(TimeZone timeZone) {
        ...
        if (timeZone != null) {
            ...
            return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._visibilityChecker, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, stdDateFormat, this._handlerInstantiator, this._locale, timeZone, this._defaultBase64);
        }

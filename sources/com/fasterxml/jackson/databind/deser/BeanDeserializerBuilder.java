...
public class BeanDeserializerBuilder {
    ...
    public JsonDeserializer<?> build() {
        ...
        BeanPropertyMap beanPropertyMap2 = new BeanPropertyMap(values);
        beanPropertyMap2.assignIndexes();
        ...
        if (this._objectIdReader != null) {
            beanPropertyMap = beanPropertyMap2.withProperty(new ObjectIdValueProperty(this._objectIdReader, true));
        } else {

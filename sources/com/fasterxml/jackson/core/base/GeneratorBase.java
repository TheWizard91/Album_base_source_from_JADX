...
public abstract class GeneratorBase extends JsonGenerator {
    ...
    public final void copyCurrentEvent(JsonParser jsonParser) throws IOException, JsonProcessingException {
        ...
        switch (C07911.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
            ...
            case 7:
                int i = C07911.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i == 1) {
            ...
            case 8:
                int i2 = C07911.$SwitchMap$com$fasterxml$jackson$core$JsonParser$NumberType[jsonParser.getNumberType().ordinal()];
                if (i2 == 3) {
    ...
    public final void copyCurrentStructure(JsonParser jsonParser) throws IOException, JsonProcessingException {
        ...
        int i = C07911.$SwitchMap$com$fasterxml$jackson$core$JsonToken[currentToken.ordinal()];
        if (i == 1) {
            writeStartObject();

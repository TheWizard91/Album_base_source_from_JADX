...
public final class FramedStream {
    ...
    FramedStream(int id, FramedConnection connection2, boolean outFinished, boolean inFinished, List<Header> requestHeaders2) {
        if (connection2 == null) {
            ...
            FramedDataSource framedDataSource = new FramedDataSource((long) connection2.okHttpSettings.getInitialWindowSize(65536));
            this.source = framedDataSource;
            FramedDataSink framedDataSink = new FramedDataSink();
            this.sink = framedDataSink;
            boolean unused = framedDataSource.finished = inFinished;
            boolean unused2 = framedDataSink.finished = outFinished;
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f182id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void reply(List<Header> responseHeaders2, boolean out) throws IOException {
        if (!Thread.holdsLock(this)) {
            ...
            this.connection.writeSynReply(this.f182id, outFinished, responseHeaders2);
            if (outFinished) {
    ...
    public void close(ErrorCode rstStatusCode) throws IOException {
        if (closeInternal(rstStatusCode)) {
            this.connection.writeSynReset(this.f182id, rstStatusCode);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f182id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        if (!Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                this.connection.removeStream(this.f182id);
                return true;
            }
        }
        throw new AssertionError();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0018, code lost:
        r3.connection.removeStream(r3.f182id);
     */
    ...
    public void receiveFin() {
        /*
            ...
            monitor-enter(r3)
            r0 = 0
            com.squareup.okhttp.internal.framed.FramedStream$FramedDataSource r1 = r3.source     // Catch:{ all -> 0x0020 }
            r2 = 1
            boolean unused = r1.finished = r2     // Catch:{ all -> 0x0020 }
    ...
    private final class FramedDataSource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:23:0x0093, code lost:
            if (com.squareup.okhttp.internal.framed.FramedStream.access$500(r1.this$0).unacknowledgedBytesRead < ((long) (com.squareup.okhttp.internal.framed.FramedStream.access$500(r1.this$0).okHttpSettings.getInitialWindowSize(65536) / 2))) goto L_0x00af;
         */
        ...
        public long read(okio.Buffer r16, long r17) throws java.io.IOException {
            /*
                ...
                monitor-enter(r6)
                r15.waitUntilReadable()     // Catch:{ all -> 0x00b9 }
                r15.checkNotClosed()     // Catch:{ all -> 0x00b9 }
                okio.Buffer r0 = r1.readBuffer     // Catch:{ all -> 0x00b9 }
                long r7 = r0.size()     // Catch:{ all -> 0x00b9 }
            ...
            L_0x0020:
                okio.Buffer r0 = r1.readBuffer     // Catch:{ all -> 0x00b9 }
                long r7 = r0.size()     // Catch:{ all -> 0x00b9 }
                long r7 = java.lang.Math.min(r2, r7)     // Catch:{ all -> 0x00b9 }
                r9 = r16
                long r7 = r0.read(r9, r7)     // Catch:{ all -> 0x00b7 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                long r10 = r0.unacknowledgedBytesRead     // Catch:{ all -> 0x00b4 }
                long r10 = r10 + r7
                r0.unacknowledgedBytesRead = r10     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                long r10 = r0.unacknowledgedBytesRead     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.Settings r0 = r0.okHttpSettings     // Catch:{ all -> 0x00b4 }
                r12 = 65536(0x10000, float:9.18355E-41)
                int r0 = r0.getInitialWindowSize(r12)     // Catch:{ all -> 0x00b4 }
                int r0 = r0 / 2
                long r13 = (long) r0     // Catch:{ all -> 0x00b4 }
                int r0 = (r10 > r13 ? 1 : (r10 == r13 ? 0 : -1))
                if (r0 < 0) goto L_0x0067
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedStream r10 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                int r10 = r10.f182id     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedStream r11 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                long r13 = r11.unacknowledgedBytesRead     // Catch:{ all -> 0x00b4 }
                r0.writeWindowUpdateLater(r10, r13)     // Catch:{ all -> 0x00b4 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b4 }
                r0.unacknowledgedBytesRead = r4     // Catch:{ all -> 0x00b4 }
            L_0x0067:
                ...
                monitor-enter(r10)
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b1 }
                long r13 = r0.unacknowledgedBytesRead     // Catch:{ all -> 0x00b1 }
                long r13 = r13 + r7
                r0.unacknowledgedBytesRead = r13     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b1 }
                long r13 = r0.unacknowledgedBytesRead     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.Settings r0 = r0.okHttpSettings     // Catch:{ all -> 0x00b1 }
                int r0 = r0.getInitialWindowSize(r12)     // Catch:{ all -> 0x00b1 }
                int r0 = r0 / 2
                long r11 = (long) r0     // Catch:{ all -> 0x00b1 }
                ...
                long r11 = r11.unacknowledgedBytesRead     // Catch:{ all -> 0x00b1 }
                r0.writeWindowUpdateLater(r6, r11)     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x00b1 }
                com.squareup.okhttp.internal.framed.FramedConnection r0 = r0.connection     // Catch:{ all -> 0x00b1 }
                r0.unacknowledgedBytesRead = r4     // Catch:{ all -> 0x00b1 }
            L_0x00af:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0054, code lost:
            if (r11.readBuffer.size() != 0) goto L_0x0057;
         */
        ...
        public void receive(okio.BufferedSource r12, long r13) throws java.io.IOException {
            ...
            L_0x000b:
                ...
                monitor-enter(r5)
                boolean r1 = r11.finished     // Catch:{ all -> 0x0077 }
                okio.Buffer r6 = r11.readBuffer     // Catch:{ all -> 0x0075 }
                long r6 = r6.size()     // Catch:{ all -> 0x0075 }
                long r6 = r6 + r13
                long r8 = r11.maxByteCount     // Catch:{ all -> 0x0075 }
            ...
            L_0x003b:
                ...
                com.squareup.okhttp.internal.framed.FramedStream r5 = com.squareup.okhttp.internal.framed.FramedStream.this
                monitor-enter(r5)
                okio.Buffer r13 = r11.readBuffer     // Catch:{ all -> 0x006a }
                long r13 = r13.size()     // Catch:{ all -> 0x006a }
            ...
            L_0x0058:
                r13 = r6
                okio.Buffer r14 = r11.readBuffer     // Catch:{ all -> 0x006a }
                okio.Buffer r3 = r11.receiveBuffer     // Catch:{ all -> 0x006a }
                r14.writeAll(r3)     // Catch:{ all -> 0x006a }
                if (r13 == 0) goto L_0x0067
                com.squareup.okhttp.internal.framed.FramedStream r14 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x006d }
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x003b, code lost:
        r4.connection.removeStream(r4.f182id);
     */
    ...
    public void cancelStreamIfNecessary() throws java.io.IOException {
        /*
            ...
            monitor-enter(r4)
            r0 = 0
            com.squareup.okhttp.internal.framed.FramedStream$FramedDataSource r1 = r4.source     // Catch:{ all -> 0x0045 }
            boolean r1 = r1.finished     // Catch:{ all -> 0x0045 }
            if (r1 != 0) goto L_0x002a
            com.squareup.okhttp.internal.framed.FramedStream$FramedDataSource r1 = r4.source     // Catch:{ all -> 0x0045 }
            boolean r1 = r1.closed     // Catch:{ all -> 0x0045 }
            if (r1 == 0) goto L_0x002a
            com.squareup.okhttp.internal.framed.FramedStream$FramedDataSink r1 = r4.sink     // Catch:{ all -> 0x0045 }
            boolean r1 = r1.finished     // Catch:{ all -> 0x0045 }
        ...
        L_0x002b:
            r2 = r1
            boolean r0 = r4.isOpen()     // Catch:{ all -> 0x0043 }
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean r10) throws java.io.IOException {
            ...
            L_0x002c:
                ...
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x0087 }
                int r4 = r0.f182id     // Catch:{ all -> 0x0087 }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0019, code lost:
            if (r8.this$0.sink.finished != false) goto L_0x0048;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0025, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x0035;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002f, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x0048;
         */
        ...
        public void close() throws java.io.IOException {
            /*
                ...
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this
                monitor-enter(r0)
                boolean r1 = r8.closed     // Catch:{ all -> 0x0060 }

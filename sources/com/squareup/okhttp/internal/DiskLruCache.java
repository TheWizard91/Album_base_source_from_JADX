...
import com.squareup.okhttp.internal.p016io.FileSystem;
...
public final class DiskLruCache implements Closeable {
    ...
    public synchronized void completeEdit(com.squareup.okhttp.internal.DiskLruCache.Editor r11, boolean r12) throws java.io.IOException {
        /*
            r10 = this;
            monitor-enter(r10)
            com.squareup.okhttp.internal.DiskLruCache$Entry r0 = r11.entry     // Catch:{ all -> 0x011b }
            com.squareup.okhttp.internal.DiskLruCache$Editor r1 = r0.currentEditor     // Catch:{ all -> 0x011b }
            if (r1 != r11) goto L_0x0115
            if (r12 == 0) goto L_0x0052
            boolean r1 = r0.readable     // Catch:{ all -> 0x011b }
            if (r1 != 0) goto L_0x0052
            r1 = 0
        L_0x0014:
            int r2 = r10.valueCount     // Catch:{ all -> 0x011b }
            if (r1 >= r2) goto L_0x0052
            boolean[] r2 = r11.written     // Catch:{ all -> 0x011b }
            boolean r2 = r2[r1]     // Catch:{ all -> 0x011b }
            if (r2 == 0) goto L_0x0036
            com.squareup.okhttp.internal.io.FileSystem r2 = r10.fileSystem     // Catch:{ all -> 0x011b }
            java.io.File[] r3 = r0.dirtyFiles     // Catch:{ all -> 0x011b }
            r3 = r3[r1]     // Catch:{ all -> 0x011b }
            boolean r2 = r2.exists(r3)     // Catch:{ all -> 0x011b }
        ...
        L_0x0036:
            r11.abort()     // Catch:{ all -> 0x011b }
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ all -> 0x011b }
            ...
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x011b }
            java.lang.StringBuilder r3 = r3.append(r1)     // Catch:{ all -> 0x011b }
        ...
        L_0x0053:
            ...
            java.io.File[] r2 = r0.dirtyFiles     // Catch:{ all -> 0x011b }
            r2 = r2[r1]     // Catch:{ all -> 0x011b }
            if (r12 == 0) goto L_0x008c
            com.squareup.okhttp.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x011b }
            boolean r3 = r3.exists(r2)     // Catch:{ all -> 0x011b }
            if (r3 == 0) goto L_0x0091
            java.io.File[] r3 = r0.cleanFiles     // Catch:{ all -> 0x011b }
            r3 = r3[r1]     // Catch:{ all -> 0x011b }
            com.squareup.okhttp.internal.io.FileSystem r4 = r10.fileSystem     // Catch:{ all -> 0x011b }
            r4.rename(r2, r3)     // Catch:{ all -> 0x011b }
            long[] r4 = r0.lengths     // Catch:{ all -> 0x011b }
            r5 = r4[r1]     // Catch:{ all -> 0x011b }
            r4 = r5
            com.squareup.okhttp.internal.io.FileSystem r6 = r10.fileSystem     // Catch:{ all -> 0x011b }
            long r6 = r6.size(r3)     // Catch:{ all -> 0x011b }
            long[] r8 = r0.lengths     // Catch:{ all -> 0x011b }
            r8[r1] = r6     // Catch:{ all -> 0x011b }
        ...
        L_0x008c:
            com.squareup.okhttp.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x011b }
            r3.delete(r2)     // Catch:{ all -> 0x011b }
        L_0x0091:
            int r1 = r1 + 1
            goto L_0x0053
        L_0x0094:
            int r1 = r10.redundantOpCount     // Catch:{ all -> 0x011b }
            r2 = 1
            int r1 = r1 + r2
            r10.redundantOpCount = r1     // Catch:{ all -> 0x011b }
            r1 = 0
            com.squareup.okhttp.internal.DiskLruCache.Editor unused = r0.currentEditor = r1     // Catch:{ all -> 0x011b }
            boolean r1 = r0.readable     // Catch:{ all -> 0x011b }
            r1 = r1 | r12
            r3 = 10
            r4 = 32
            ...
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
            java.lang.String r2 = "CLEAN"
            okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x011b }
            r1.writeByte(r4)     // Catch:{ all -> 0x011b }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x011b }
            r1.writeUtf8(r2)     // Catch:{ all -> 0x011b }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
            r0.writeLengths(r1)     // Catch:{ all -> 0x011b }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
            r1.writeByte(r3)     // Catch:{ all -> 0x011b }
            if (r12 == 0) goto L_0x00f9
            long r1 = r10.nextSequenceNumber     // Catch:{ all -> 0x011b }
            r3 = 1
            long r3 = r3 + r1
            r10.nextSequenceNumber = r3     // Catch:{ all -> 0x011b }
            long unused = r0.sequenceNumber = r1     // Catch:{ all -> 0x011b }
            goto L_0x00f9
        L_0x00d7:
            java.util.LinkedHashMap<java.lang.String, com.squareup.okhttp.internal.DiskLruCache$Entry> r1 = r10.lruEntries     // Catch:{ all -> 0x011b }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x011b }
            r1.remove(r2)     // Catch:{ all -> 0x011b }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
        ...
        L_0x00f9:
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x011b }
            r1.flush()     // Catch:{ all -> 0x011b }
            long r1 = r10.size     // Catch:{ all -> 0x011b }
            long r3 = r10.maxSize     // Catch:{ all -> 0x011b }
            int r1 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r1 > 0) goto L_0x010c
            boolean r1 = r10.journalRebuildRequired()     // Catch:{ all -> 0x011b }
            if (r1 == 0) goto L_0x0113
        L_0x010c:
            java.util.concurrent.Executor r1 = r10.executor     // Catch:{ all -> 0x011b }
            java.lang.Runnable r2 = r10.cleanupRunnable     // Catch:{ all -> 0x011b }
            r1.execute(r2)     // Catch:{ all -> 0x011b }
        L_0x0113:
            monitor-exit(r10)
            return
        L_0x0115:

...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public int selectPrefix(Options options, boolean selectTruncated) {
        ...
        if (head2 != null) {
            ...
            while (true) {
                ...
                int possiblePrefixIndex = trie[triePos3];
                ...
                if (scanOrSelect2 < 0) {
                    int trieLimit = triePos4 + (scanOrSelect2 * -1);
                    while (true) {
                        int pos2 = pos + 1;
                    ...
                    while (triePos4 != selectLimit) {
                        if (b2 == trie[triePos4]) {
                            ...
                            if (pos3 == limit) {
                                ...
                                if (s == head2) {
                                    s = null;
                                    int selectChoiceCount2 = triePos4;
                                    pos = pos4;
                                    triePos = nextStep;
                                } else {
                                    int selectChoiceCount3 = triePos4;
                                    pos = pos4;
                                    triePos = nextStep;
                                }
                            } else {
                                int selectChoiceCount4 = triePos4;
                                pos = pos3;
                                triePos = nextStep;
                            }
                        } else {
    ...
    private ByteString digest(String algorithm) {
        try {
            ...
            return ByteString.m234of(messageDigest.digest());
    ...
    private ByteString hmac(String algorithm, ByteString key) {
        try {
            ...
            return ByteString.m234of(mac.doFinal());
        } catch (NoSuchAlgorithmException e) {
            throw new AssertionError();
